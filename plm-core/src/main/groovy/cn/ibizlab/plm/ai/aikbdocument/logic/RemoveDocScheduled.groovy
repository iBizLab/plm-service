...
/**
 * 实体[AI_KB_DOCUMENT]处理逻辑[删除文档执行计划]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class RemoveDocScheduled extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveDocScheduled.class)
