...
/**
 * 实体[AI_AGENT_CONVERSATION]处理逻辑[除指定外清空会话]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ClearAllExcept extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ClearAllExcept.class)
