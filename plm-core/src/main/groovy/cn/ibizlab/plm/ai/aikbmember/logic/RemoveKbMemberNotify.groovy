package cn.ibizlab.plm.ai.aikbmember.logic
...
/**
 * 实体[AI_KB_MEMBER]处理逻辑[移除知识库成员发送通知]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移除知识库成员时向对应用户发送通知消息
 */
class RemoveKbMemberNotify extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveKbMemberNotify.class)
    ...
    /**
     * 执行逻辑节点[获取知识库成员数据]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[移除知识库成员通知]，逻辑类型[DENOTIFY]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
