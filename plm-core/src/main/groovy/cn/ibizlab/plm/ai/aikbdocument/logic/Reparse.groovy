...
/**
 * 实体[AI_KB_DOCUMENT]处理逻辑[文档重新解析]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Reparse extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Reparse.class)
    ...
    /**
     * 执行逻辑节点[置空parsed_content]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
