...
/**
 * 实体[AI_KB_DOCUMENT_SYNC]处理逻辑[删除空间执行计划]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class RemoveSpaceScheduled extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveSpaceScheduled.class)
