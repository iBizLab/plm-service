package cn.ibizlab.plm.ai.aiagentmessage.logic
...
/**
 * 实体[AI_AGENT_MESSAGE]处理逻辑[取消点赞或点踩]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class CancelFeedback extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CancelFeedback.class)
    ...
    /**
     * 执行逻辑节点[准备查询参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
