...
/**
 * 实体[AI_KB_DOCUMENT_SYNC]处理逻辑[同步创建知识库文档]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class SyncCreateDoc extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SyncCreateDoc.class)
    ...
    /**
     * 执行逻辑节点[查询空间下的页面]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
