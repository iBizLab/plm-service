...
/**
 * 实体[AI_KB_DOCUMENT]处理逻辑[未切片数据集]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Unparsed extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Unparsed.class)
    ...
    /**
     * 执行逻辑节点[置空查询parsing_config]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
