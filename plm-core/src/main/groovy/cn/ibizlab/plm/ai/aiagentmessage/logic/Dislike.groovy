...
/**
 * 实体[AI_AGENT_MESSAGE]处理逻辑[点踩]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Dislike extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Dislike.class)
    ...
    /**
     * 执行逻辑节点[准备点赞参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
