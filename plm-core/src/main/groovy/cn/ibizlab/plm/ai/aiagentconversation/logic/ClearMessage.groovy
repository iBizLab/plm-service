package cn.ibizlab.plm.ai.aiagentconversation.logic
...
/**
 * 实体[AI_AGENT_CONVERSATION]处理逻辑[清空消息]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ClearMessage extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ClearMessage.class)
