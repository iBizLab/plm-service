...
/**
 * 实体[AI_KB_DOCUMENT]处理逻辑[更新文档执行计划]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class UpdateDocScheduled extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UpdateDocScheduled.class)
    ...
    /**
     * 执行逻辑节点[过滤文档对应计划]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
