...
/**
 * 实体[AI_AGENT_CONTEXT]处理逻辑[fill_with_agent]运行时对象
 * 此代码用户功能扩展代码
 *
 * 由插件补充填充，此配置仅作为填充入口
 */
class FillWithAgent extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillWithAgent.class)
