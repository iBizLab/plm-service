...
/**
 * 实体[AI_KB_DOCUMENT]处理逻辑[参考引用]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class References extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(References.class)
    ...
    /**
     * 执行逻辑节点[提取references]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
