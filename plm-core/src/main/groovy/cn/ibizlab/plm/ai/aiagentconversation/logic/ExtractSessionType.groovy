...
/**
 * 实体[AI_AGENT_CONVERSATION]处理逻辑[提取session前缀并存储]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class ExtractSessionType extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ExtractSessionType.class)
