package cn.ibizlab.plm.ai.aiagentcontext.logic
...
/**
 * 实体[AI_AGENT_CONTEXT]处理逻辑[reload_aiagents]运行时对象
 * 此代码用户功能扩展代码
 *
 * 重载AI代理对象
 */
class ReloadAiagents extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ReloadAiagents.class)
