...
/**
 * 实体[AI_KB_DOCUMENT_SYNC]处理逻辑[更新空间执行计划]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class UpdateSpaceScheduled extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UpdateSpaceScheduled.class)
    ...
    /**
     * 执行逻辑节点[过滤空间对应计划]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
