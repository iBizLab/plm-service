...
/**
 * 实体[AI_AGENT_CONTEXT]处理逻辑[删除logic扩展模型]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class DeleteExtendModel extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DeleteExtendModel.class)
    ...
    /**
     * 执行逻辑节点[获取extend_logic]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[删除extend_logic]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取agent_context]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查看logic数据]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[拼接model标识]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
