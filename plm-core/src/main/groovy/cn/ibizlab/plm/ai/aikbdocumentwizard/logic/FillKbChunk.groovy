...
/**
 * 实体[AI_KB_DOCUMENT_WIZARD]处理逻辑[填充知识库切片策略]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class FillKbChunk extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillKbChunk.class)
    ...
    /**
     * 执行逻辑节点[查询知识库切片策略]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充知识库参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
