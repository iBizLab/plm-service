package cn.ibizlab.plm.ai.aikbgraphentity.logic
...
/**
 * 实体[AI_KB_GRAPH_ENTITY]处理逻辑[获取图谱实体/关系信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GraphInfo extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GraphInfo.class)
