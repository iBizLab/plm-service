...
/**
 * 实体[AI_KB_DOCUMENT_SYNC]处理逻辑[同步删除文档和分块]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class SyncRemoveDocChunk extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SyncRemoveDocChunk.class)
