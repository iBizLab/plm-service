...
/**
 * 实体[AI_AGENT_MESSAGE]处理逻辑[点赞]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Like extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Like.class)
