...
/**
 * 实体[PSDELOGIC]处理逻辑[初始化规则]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class InitLogic extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(InitLogic.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            ...
            case "APPENDPARAM_02":
                //执行逻辑节点[附加到数组参数]
                executeAppendparam02(iDELogicSession, iPSDELogicNode)
                break
    ...
    /**
     * 执行逻辑节点[准备默认变量参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备事件变量参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
     ...
     * @throws Throwable
     */
    private void executeAppendparam02(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }

    /**
     * 执行逻辑节点[设置预置变量参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
