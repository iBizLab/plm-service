 ...
 *
 */
class SystemExtensionNotifySetting extends GroovyDynaDataEntityRuntime<SystemExtensionNotifySetting,SystemExtensionNotifySettingDTO,SystemExtensionNotifySettingFilterDTO> {
