package cn.ibizlab.plm.extension.about.logic
...
/**
 * 实体[ABOUT]处理逻辑[获取关于信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetAboutInfo extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetAboutInfo.class)
