...
/**
 * 实体[BASELINE]处理逻辑[设立完成（测试库）]运行时对象
 * 此代码用户功能扩展代码
 *
 * 测试库基线设立完成
 */
class SetCompleteLibrary extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetCompleteLibrary.class)
    ...
    /**
     * 执行逻辑节点[获取基线下关联的用例]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充测试用例对象主键标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
