package cn.ibizlab.plm.base.user.logic
...
/**
 * 实体[USER]处理逻辑[取消统计]运行时对象
 * 此代码用户功能扩展代码
 *
 * 取消用户统计状态
 */
class CancelReportFlag extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CancelReportFlag.class)
    ...
    /**
     * 执行逻辑节点[设置用户参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
