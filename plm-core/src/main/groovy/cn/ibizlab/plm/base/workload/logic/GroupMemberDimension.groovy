...
/**
 * 实体[WORKLOAD]处理逻辑[团队下成员工时日历查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 通过团队标识，查询此团队下的成员工时日历
 */
class GroupMemberDimension extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GroupMemberDimension.class)
    ...
    /**
     * 执行逻辑节点[重置查询分页参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
