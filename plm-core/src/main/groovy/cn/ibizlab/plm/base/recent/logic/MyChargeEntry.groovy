package cn.ibizlab.plm.base.recent.logic
...
/**
 * 实体[RECENT]处理逻辑[我负责的事项]运行时对象
 * 此代码用户功能扩展代码
 *
 * 查询我负责的事项，工作台的计数器使用
 */
class MyChargeEntry extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MyChargeEntry.class)
    ...
    /**
     * 执行逻辑节点[我负责的工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[我负责的产品需求]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[我负责的测试用例]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
