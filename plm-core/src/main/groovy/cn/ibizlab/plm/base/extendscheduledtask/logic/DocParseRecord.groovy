package cn.ibizlab.plm.base.extendscheduledtask.logic
...
/**
 * 实体[EXTEND_SCHEDULED_TASK]处理逻辑[文档解析记录]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class DocParseRecord extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DocParseRecord.class)
    ...
    /**
     * 执行逻辑节点[构造执行记录信息]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
