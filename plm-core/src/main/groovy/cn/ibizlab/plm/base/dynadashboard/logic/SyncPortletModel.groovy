package cn.ibizlab.plm.base.dynadashboard.logic
...
/**
 * 实体[DYNADASHBOARD]处理逻辑[更新看板部件模型]运行时对象
 * 此代码用户功能扩展代码
 *
 * 更新看板部件模型
 */
class SyncPortletModel extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SyncPortletModel.class)
    ...
    /**
     * 执行逻辑节点[更新看板部件模型]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
