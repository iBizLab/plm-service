...
/**
 * 实体[WORKLOAD]处理逻辑[人员维度工时日历查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工时管理菜单中工时日历：人员维度查询数据使用
 */
class MemberDimension extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MemberDimension.class)
