...
/**
 * 实体[RECENT]处理逻辑[我创建的事项]运行时对象
 * 此代码用户功能扩展代码
 *
 * 查询当前用户创建的事项
 */
class MyCreatedEntry extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MyCreatedEntry.class)
    ...
    /**
     * 执行逻辑节点[我创建的工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[我创建的产品需求]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[我创建的测试用例]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
