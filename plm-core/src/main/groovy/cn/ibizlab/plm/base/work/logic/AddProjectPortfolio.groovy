...
/**
 * 实体[WORK]处理逻辑[添加项目集]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目集下添加子项目集。注：只可选择无子项目集的，预防反复嵌套
 */
class AddProjectPortfolio extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddProjectPortfolio.class)
    ...
    /**
     * 执行逻辑节点[设置当前工作对象信息]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
