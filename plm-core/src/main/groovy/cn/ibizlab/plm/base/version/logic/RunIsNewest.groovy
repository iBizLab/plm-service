...
/**
 * 实体[VERSION]处理逻辑[判断执行用例是否为最新版本]运行时对象
 * 此代码用户功能扩展代码
 *
 * 当新建版本后，判断测试用例对应的执行用例是否为最新版本，变更newest属性
 */
class RunIsNewest extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RunIsNewest.class)
    ...
    /**
     * 执行逻辑节点[查询执行用例数据]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[输出循环执行用例结果]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置是否最新版本参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
