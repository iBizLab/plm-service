package cn.ibizlab.plm.base.work.logic
...
/**
 * 实体[WORK]处理逻辑[添加项目]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目集下添加子项目
 */
class AddProject extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddProject.class)
    ...
    /**
     * 执行逻辑节点[获取选中数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重置工作对象参数]，逻辑类型[RESETPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备工作对象参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
