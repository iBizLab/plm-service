...
/**
 * 实体[WORKLOAD]处理逻辑[工作项维度工时日历查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 首页工作台工时日历：项目/工作项维度查询数据使用
 */
class WorkItemDimension extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(WorkItemDimension.class)
    ...
    /**
     * 执行逻辑节点[查询我登记的工作项工时]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
