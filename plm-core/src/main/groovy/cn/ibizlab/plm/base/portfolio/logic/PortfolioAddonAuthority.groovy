...
/**
 * 实体[PORTFOLIO]处理逻辑[项目集组件权限计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取项目集组件权限
 */
class PortfolioAddonAuthority extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(PortfolioAddonAuthority.class)
