package cn.ibizlab.plm.base.addon.logic
...
/**
 * 实体[ADDON]处理逻辑[组件权限计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取组件权限计数器是数值
 */
class AddonAuthority extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddonAuthority.class)
