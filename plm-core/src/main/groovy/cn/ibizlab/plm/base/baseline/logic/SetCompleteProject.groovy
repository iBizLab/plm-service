...
/**
 * 实体[BASELINE]处理逻辑[设立完成（项目）]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目基线设立完成
 */
class SetCompleteProject extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetCompleteProject.class)
    ...
    /**
     * 执行逻辑节点[获取基线下关联的工作项]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重置工作项参数]，逻辑类型[RESETPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充工作项对象主键标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
