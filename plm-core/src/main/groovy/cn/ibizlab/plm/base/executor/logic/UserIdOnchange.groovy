package cn.ibizlab.plm.base.executor.logic
...
/**
 * 实体[EXECUTOR]处理逻辑[执行人变更附加逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 执行人变更附加逻辑
 */
class UserIdOnchange extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UserIdOnchange.class)
    ...
    /**
     * 执行逻辑节点[记录变更前修改时间]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[通知取消工作项分配执行人]，逻辑类型[DENOTIFY]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
