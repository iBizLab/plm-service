...
/**
 * 实体[PORTFOLIO]处理逻辑[恢复项目集]运行时对象
 * 此代码用户功能扩展代码
 *
 * 恢复已删除状态项目集数据，修改项目集的是否删除属性值
 */
class RecoverProjectSet extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RecoverProjectSet.class)
    ...
    /**
     * 执行逻辑节点[设置项目集恢复状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[更新项目集恢复状态]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
