package cn.ibizlab.plm.base.department.logic
...
/**
 * 实体[DEPARTMENT]处理逻辑[部门过滤]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class DeptFilter extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DeptFilter.class)
