...
/**
 * 实体[WORKLOAD]处理逻辑[登记工时并更新剩余工时]运行时对象
 * 此代码用户功能扩展代码
 *
 * 保存实际登记工时记录，并计算重置剩余工时属性
 */
class SaveWorkload extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SaveWorkload.class)
