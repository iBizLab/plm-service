...
/**
 * 实体[MEMBER]处理逻辑[非空间下成员]运行时对象
 * 此代码用户功能扩展代码
 *
 * 非空间下成员
 */
class NotSpaceMmeber extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(NotSpaceMmeber.class)
    ...
    /**
     * 执行逻辑节点[查询非空间成员]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备空间成员查询过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取已添加的共享页面成员]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充user过滤器ni参数]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
