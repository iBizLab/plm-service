...
/**
 * 实体[WORKLOAD]处理逻辑[测试用例维度管理工时日历查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工时管理菜单中工时日历：测试库/测试用例维度查询数据使用
 */
class TestCaseManagementDimension extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(TestCaseManagementDimension.class)
    ...
    /**
     * 执行逻辑节点[查询测试用例工时]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
