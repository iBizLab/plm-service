...
/**
 * 实体[WORKLOAD]处理逻辑[填充工时数据]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移动端，工时日历详情使用
 */
class FillWorkloadData extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillWorkloadData.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            case "Begin":
                ...
                break
            case "PREPAREPARAM1":
                //执行逻辑节点[设置工时principal_id]
                executePREPAREPARAM1(iDELogicSession, iPSDELogicNode)
                break
            case "RAWSQLCALL1":
                //执行逻辑节点[获取工时信息外加work_item_type_id]
    ...
    /**
     * 执行逻辑节点[设置工时principal_id]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取工时信息外加work_item_type_id]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
