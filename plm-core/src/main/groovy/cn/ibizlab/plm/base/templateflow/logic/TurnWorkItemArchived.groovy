...
/**
 * 实体[TEMPLATE_FLOW]处理逻辑[定时将已完成工作项归档]运行时对象
 * 此代码用户功能扩展代码
 *
 * 通过定时任务，将已完成的工作项归档，结束时间超过三天。
 */
class TurnWorkItemArchived extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(TurnWorkItemArchived.class)
    ...
    /**
     * 执行逻辑节点[设置工作项过滤条件]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取符合条件的工作项]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[逐工作项执行]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
