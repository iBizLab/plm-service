...
/**
 * 实体[SECTION]处理逻辑[删除分组及其下类别]运行时对象
 * 此代码用户功能扩展代码
 *
 * 删除分组及其下子类别（测试）
 */
class DeleteSection extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DeleteSection.class)
