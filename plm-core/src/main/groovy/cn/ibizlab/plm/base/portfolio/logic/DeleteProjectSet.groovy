package cn.ibizlab.plm.base.portfolio.logic
...
/**
 * 实体[PORTFOLIO]处理逻辑[删除项目集]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目集数据的逻辑删除，修改项目集的是否删除属性值
 */
class DeleteProjectSet extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DeleteProjectSet.class)
    ...
    /**
     * 执行逻辑节点[设置项目集删除状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[更新项目集删除状态]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
