...
/**
 * 实体[RELATION]处理逻辑[区分前后置任务]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项依赖：区分前后置任务
 */
class DifferentiateJobType extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DifferentiateJobType.class)
    ...
    /**
     * 执行逻辑节点[填充任务类型]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
