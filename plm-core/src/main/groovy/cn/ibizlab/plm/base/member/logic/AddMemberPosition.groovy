...
/**
 * 实体[MEMBER]处理逻辑[添加成员（职位）]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class AddMemberPosition extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddMemberPosition.class)
    ...
    /**
     * 执行逻辑节点[填充团队成员属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
