...
/**
 * 实体[NOTIFY_SETTING]处理逻辑[保存设置]运行时对象
 * 此代码用户功能扩展代码
 *
 * 保存通知设置
 */
class SaveSetting extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SaveSetting.class)
