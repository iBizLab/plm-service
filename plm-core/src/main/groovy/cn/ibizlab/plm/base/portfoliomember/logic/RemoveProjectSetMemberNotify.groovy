package cn.ibizlab.plm.base.portfoliomember.logic
...
/**
 * 实体[PORTFOLIO_MEMBER]处理逻辑[移除项目集成员通知]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移除项目集成员时向对应用户发送通知消息
 */
class RemoveProjectSetMemberNotify extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveProjectSetMemberNotify.class)
    ...
    /**
     * 执行逻辑节点[获取文件夹成员数据]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[绑定当前操作人]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取当前操作时间]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
