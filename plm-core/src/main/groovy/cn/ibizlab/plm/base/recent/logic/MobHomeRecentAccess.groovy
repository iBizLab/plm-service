...
/**
 * 实体[RECENT]处理逻辑[移动端首页_最近访问]运行时对象
 * 此代码用户功能扩展代码
 *
 * 仅查询最近5条访问
 */
class MobHomeRecentAccess extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MobHomeRecentAccess.class)
    ...
    /**
     * 执行逻辑节点[设置固定条数为5]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询最近访问记录]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
