...
/**
 * 实体[MEMBER]处理逻辑[获取当前项目下资源成员]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取当前项目下资源成员
 */
class CurProjectResource extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CurProjectResource.class)
