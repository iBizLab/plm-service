...
/**
 * 实体[TEMPLATE_FLOW]处理逻辑[自动设置工作项负责人]运行时对象
 * 此代码用户功能扩展代码
 *
 * 自动化，自动设置工作项负责人
 */
class AutoFillAssignMan extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AutoFillAssignMan.class)
