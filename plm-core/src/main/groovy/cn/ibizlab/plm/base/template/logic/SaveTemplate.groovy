package cn.ibizlab.plm.base.template.logic
...
/**
 * 实体[TEMPLATE]处理逻辑[保存模板]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class SaveTemplate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SaveTemplate.class)
