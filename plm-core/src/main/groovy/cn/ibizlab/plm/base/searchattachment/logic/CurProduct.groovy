...
/**
 * 实体[SEARCH_ATTACHMENT]处理逻辑[产品中需求或工单的附件]运行时对象
 * 此代码用户功能扩展代码
 *
 * 当前产品下的全部附件，用于填充所属相关信息字段
 */
class CurProduct extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CurProduct.class)
    ...
    /**
     * 执行逻辑节点[当前产品下的全部附件]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
