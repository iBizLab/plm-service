...
/**
 * 实体[USER]处理逻辑[统计过滤]运行时对象
 * 此代码用户功能扩展代码
 *
 * 排除非统计用户
 */
class ReportFlagFilter extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ReportFlagFilter.class)
