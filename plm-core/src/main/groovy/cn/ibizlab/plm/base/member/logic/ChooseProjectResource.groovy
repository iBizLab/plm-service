...
/**
 * 实体[MEMBER]处理逻辑[选择项目资源成员]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目资源分配下设置成员：当前项目下成员/部门/团队
 */
class ChooseProjectResource extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChooseProjectResource.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            ...
            case "LOOPSUBCALL3":
                ...
                break
            case "PREPAREPARAM7":
                //执行逻辑节点[设置用户标识与标识一致，目的已选择的成员不可再次勾选]
            ...
            case "END3":
                //执行逻辑节点[结束]
                executeEND3(iDELogicSession, iPSDELogicNode)
                break
            default:
    ...
    /**
     * 执行逻辑节点[设置查询分页参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备当前项目成员过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备部门成员过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备团队成员过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取当前项目下成员]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置用户标识与标识一致，目的已选择的成员不可再次勾选]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充用户标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
     ...
     * @throws Throwable
     */
    private void executeEND3(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
}
