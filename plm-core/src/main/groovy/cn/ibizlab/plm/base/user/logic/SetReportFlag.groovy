...
/**
 * 实体[USER]处理逻辑[设置统计]运行时对象
 * 此代码用户功能扩展代码
 *
 * 更新用户统计状态
 */
class SetReportFlag extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetReportFlag.class)
