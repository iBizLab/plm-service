...
/**
 * 实体[RELATION]处理逻辑[测试用例取消关联缺陷]运行时对象
 * 此代码用户功能扩展代码
 *
 * 1.测试用例取消关联缺陷 2.对应执行用例取消关联缺陷
 */
class TestCaseDelRelationBug extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(TestCaseDelRelationBug.class)
