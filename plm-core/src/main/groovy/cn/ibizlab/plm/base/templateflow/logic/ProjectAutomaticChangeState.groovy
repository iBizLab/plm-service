package cn.ibizlab.plm.base.templateflow.logic
...
/**
 * 实体[TEMPLATE_FLOW]处理逻辑[项目自动变更状态]运行时对象
 * 此代码用户功能扩展代码
 *
 * 定时执行，当项目的结束时间小于当前日期时，自动将项目状态变更为延期；
当项目的结束时间距今不足五天时，自动将项目状态变更为预警；
 */
class ProjectAutomaticChangeState extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProjectAutomaticChangeState.class)
    ...
    /**
     * 执行逻辑节点[设置逾期项目过滤条件]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取符合条件的逾期项目]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[空节点，承载判断]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[判断当前项目是否存在工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置状态为延期]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置状态为预警]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置状态为正常]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[汇聚预计、消耗工时]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
