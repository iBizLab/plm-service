...
/**
 * 实体[WORKLOAD]处理逻辑[工作类别维度工时日历查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 首页工作台工时日历：工作类型维度查询数据使用
 */
class TypeOfDimension extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(TypeOfDimension.class)
    ...
    /**
     * 执行逻辑节点[查询我登记的工作类别工时]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
