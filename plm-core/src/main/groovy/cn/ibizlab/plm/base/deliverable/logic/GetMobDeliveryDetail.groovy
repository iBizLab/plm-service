package cn.ibizlab.plm.base.deliverable.logic
...
/**
 * 实体[DELIVERABLE]处理逻辑[获取交付物详情]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetMobDeliveryDetail extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetMobDeliveryDetail.class)
    ...
    /**
     * 执行逻辑节点[交付物default]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置工作项信息]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置交付物工作项参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
