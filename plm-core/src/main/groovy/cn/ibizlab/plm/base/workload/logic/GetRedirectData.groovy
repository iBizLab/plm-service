...
/**
 * 实体[WORKLOAD]处理逻辑[获取重定向数据]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class GetRedirectData extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetRedirectData.class)
