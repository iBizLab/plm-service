package cn.ibizlab.plm.base.addonresource.logic
...
/**
 * 实体[ADDON_RESOURCE]处理逻辑[检验资源是否已删除]运行时对象
 * 此代码用户功能扩展代码
 *
 * 判断资源是否已删除，用于视图切换逻辑
 */
class CheckResourceIsDeleted extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CheckResourceIsDeleted.class)
