...
/**
 * 实体[MEMBER]处理逻辑[获取资源成员（全局）]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取资源成员（全局）
 */
class ResourceMember extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ResourceMember.class)
    ...
    /**
     * 执行逻辑节点[设置全局资源组件标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
