package cn.ibizlab.plm.base.searchattachment.logic
...
/**
 * 实体[SEARCH_ATTACHMENT]处理逻辑[高级搜索]运行时对象
 * 此代码用户功能扩展代码
 *
 * 高级搜索，用于填充所属相关信息字段
 */
class AdvancedSearch extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[绑定产品需求参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[绑定测试用例参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
