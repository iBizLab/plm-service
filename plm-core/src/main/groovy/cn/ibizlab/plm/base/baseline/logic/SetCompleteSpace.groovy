...
/**
 * 实体[BASELINE]处理逻辑[设置完成（空间）]运行时对象
 * 此代码用户功能扩展代码
 *
 * 空间基线设立完成
 */
class SetCompleteSpace extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetCompleteSpace.class)
    ...
    /**
     * 执行逻辑节点[设立完成状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取基线下关联的页面]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
