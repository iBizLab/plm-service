...
/**
 * 实体[PORTFOLIO]处理逻辑[从项目集中移除]运行时对象
 * 此代码用户功能扩展代码
 *
 * 从项目集中移除指定的子项目集
 */
class RemoveFromProjectSet extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveFromProjectSet.class)
    ...
    /**
     * 执行逻辑节点[从项目集中移除]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
