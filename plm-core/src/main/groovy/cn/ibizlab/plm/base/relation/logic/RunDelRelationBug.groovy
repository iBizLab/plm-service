...
/**
 * 实体[RELATION]处理逻辑[执行用例取消关联缺陷]运行时对象
 * 此代码用户功能扩展代码
 *
 * 1.执行用例取消关联缺陷 2.对应测试用例取消关联缺陷
 */
class RunDelRelationBug extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RunDelRelationBug.class)
    ...
    /**
     * 执行逻辑节点[准备执行用例参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充正反关联对象的主要关联属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备关联数据过滤参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[删除测试用例关联缺陷数据]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[删除缺陷关联测试用例数据]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
