...
/**
 * 实体[WORK_ITEM]处理逻辑[其他实体关联工作项]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项实体的关联操作，生成正向，反向关联数据
 */
class OthersRelationWorkItem extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(OthersRelationWorkItem.class)
    ...
    /**
     * 执行逻辑节点[存在关联类型]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重复或关联]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
