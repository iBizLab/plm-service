package cn.ibizlab.plm.projmgmt.projecttag.logic
...
/**
 * 实体[PROJECT_TAG]处理逻辑[删除标签]运行时对象
 * 此代码用户功能扩展代码
 *
 * 删除标签时对工作项的标签属性进行处理
 */
class DeleteTag extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DeleteTag.class)
