...
/**
 * 实体[WORK_ITEM]处理逻辑[填充状态的类型]运行时对象
 * 此代码用户功能扩展代码
 *
 * 根据工作项状态的id获取对应的type值
 */
class FillTypeOfState extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillTypeOfState.class)
    ...
    /**
     * 执行逻辑节点[设置工作项状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
