...
/**
 * 实体[RELEASE]处理逻辑[发布时间变更附加逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 更新最末发布阶段的时间
 */
class EndAtOnchange extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(EndAtOnchange.class)
    ...
    /**
     * 执行逻辑节点[填充更新发布对象标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[同步发布时间]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[将发布时间同步更新至末阶段时间]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
