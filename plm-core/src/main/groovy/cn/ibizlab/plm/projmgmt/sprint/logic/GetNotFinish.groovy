...
/**
 * 实体[SPRINT]处理逻辑[获取未完成的工作项数量]运行时对象
 * 此代码用户功能扩展代码
 *
 * 完成迭代时，判断此迭代下是否存在未完成的工作项；提醒用户是否将未完成的工作项状态变更至已完成
 */
class GetNotFinish extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetNotFinish.class)
    ...
    /**
     * 执行逻辑节点[查询该迭代下未完成的工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充完成信息]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[添加未完成提醒内容]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
