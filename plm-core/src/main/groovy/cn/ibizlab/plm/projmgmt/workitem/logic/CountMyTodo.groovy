...
/**
 * 实体[WORK_ITEM]处理逻辑[首页待完成项计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 首页待完成项计数器
 */
class CountMyTodo extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CountMyTodo.class)
    ...
    /**
     * 执行逻辑节点[查询我的待完成]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
