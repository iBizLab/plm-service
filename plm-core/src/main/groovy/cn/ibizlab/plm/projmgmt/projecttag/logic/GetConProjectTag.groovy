...
/**
 * 实体[PROJECT_TAG]处理逻辑[获取关联的工作项]运行时对象
 * 此代码用户功能扩展代码
 *
 * 在删除项目标签时，获取与之关联的工作项数量。
 */
class GetConProjectTag extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetConProjectTag.class)
    ...
    /**
     * 执行逻辑节点[准备工作项数量参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[添加工作项数量提醒内容]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
