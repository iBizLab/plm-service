...
/**
 * 实体[WORK_ITEM]处理逻辑[移动时子工作项的处理]运行时对象
 * 此代码用户功能扩展代码
 *
 * 父工作项移动; 子工作项也移动;并对Top_id进行更新
 */
class MoveChildWorkItem extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MoveChildWorkItem.class)
    ...
    /**
     * 执行逻辑节点[获取所有子工作项]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[子工作项项目继承父工作项的项目标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
