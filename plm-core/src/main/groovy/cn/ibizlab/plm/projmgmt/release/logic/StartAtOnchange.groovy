...
/**
 * 实体[RELEASE]处理逻辑[开始时间变更附加逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 更新首个发布阶段的时间
 */
class StartAtOnchange extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(StartAtOnchange.class)
    ...
    /**
     * 执行逻辑节点[填充更新发布标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取首个阶段标识]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[同步开始时间]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[将开始时间同步更新至首阶段时间]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
