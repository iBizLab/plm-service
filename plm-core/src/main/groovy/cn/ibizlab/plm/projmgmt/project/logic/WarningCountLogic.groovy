...
/**
 * 实体[PROJECT]处理逻辑[逾期工作项计数]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class WarningCountLogic extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(WarningCountLogic.class)
    ...
    /**
     * 执行逻辑节点[统计逾期、预警、当前预警]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
