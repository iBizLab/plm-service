...
/**
 * 实体[PROJECT]处理逻辑[生成默认看板]运行时对象
 * 此代码用户功能扩展代码
 *
 * 新建看板项目后，会附加生成出默认看板
 */
class CreateDefaultBoard extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreateDefaultBoard.class)
    ...
    /**
     * 执行逻辑节点[默认看板名称]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
