...
/**
 * 实体[WORK_ITEM]处理逻辑[填充待完成事项数量]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移动端工作台首页：获取待完成事项数量
 */
class FillNotCompletedNum extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillNotCompletedNum.class)
    ...
    /**
     * 执行逻辑节点[获取待完成事项数量]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
