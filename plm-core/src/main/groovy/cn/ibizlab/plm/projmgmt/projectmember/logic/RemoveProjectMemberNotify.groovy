package cn.ibizlab.plm.projmgmt.projectmember.logic
...
/**
 * 实体[PROJECT_MEMBER]处理逻辑[移除项目成员通知]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移除项目成员时向对应用户发送通知消息
 */
class RemoveProjectMemberNotify extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveProjectMemberNotify.class)
    ...
    /**
     * 执行逻辑节点[填充当前操作人]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
