...
/**
 * 实体[WORK_ITEM]处理逻辑[恢复]运行时对象
 * 此代码用户功能扩展代码
 *
 * 递归所有下级工作项，恢复已删除状态工作项数据，修改工作项的是否删除属性值，并恢复访问记录，标记上级为非叶子节点
 */
class Recover extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Recover.class)
    ...
    /**
     * 执行逻辑节点[设置删除状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置父工作项非叶子节点]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[更新父工作项非叶子节点]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置工作项过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
