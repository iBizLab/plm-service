...
/**
 * 实体[WORK_ITEM]处理逻辑[变更父工作项]运行时对象
 * 此代码用户功能扩展代码
 *
 * 变更父工作项
 */
class ChangeParent extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChangeParent.class)
    ...
    /**
     * 执行逻辑节点[绑定选中数据列表参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充工作项父级标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
