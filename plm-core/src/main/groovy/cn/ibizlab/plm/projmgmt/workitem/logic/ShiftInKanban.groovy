...
/**
 * 实体[WORK_ITEM]处理逻辑[移入看板]运行时对象
 * 此代码用户功能扩展代码
 *
 * 将工作项移入对应看板
 */
class ShiftInKanban extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ShiftInKanban.class)
    ...
    /**
     * 执行逻辑节点[默认移入至首个看板栏]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充看板栏标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备看板过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取指定看板下的看板栏]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
