...
/**
 * 实体[BASELINE_WORK_ITEM]处理逻辑[移出基线]运行时对象
 * 此代码用户功能扩展代码
 *
 * 将工作项移出对应基线
 */
class ShiftOutBaseline extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ShiftOutBaseline.class)
    ...
    /**
     * 执行逻辑节点[删除基线-工作项关联数据]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
