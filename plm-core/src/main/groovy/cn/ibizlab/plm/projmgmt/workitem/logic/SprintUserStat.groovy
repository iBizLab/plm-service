...
/**
 * 实体[WORK_ITEM]处理逻辑[成员负荷报告]运行时对象
 * 此代码用户功能扩展代码
 *
 * 成员负荷报告数据源
 */
class SprintUserStat extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SprintUserStat.class)
    ...
    /**
     * 执行逻辑节点[查询成员负荷报告]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
