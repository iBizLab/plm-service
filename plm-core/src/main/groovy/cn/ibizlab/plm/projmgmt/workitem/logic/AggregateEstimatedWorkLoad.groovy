...
/**
 * 实体[WORK_ITEM]处理逻辑[汇聚预估工时]运行时对象
 * 此代码用户功能扩展代码
 *
 * 预估工时属性变更触发
 */
class AggregateEstimatedWorkLoad extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AggregateEstimatedWorkLoad.class)
    ...
    /**
     * 执行逻辑节点[获取当前级的工时，赋值给父]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
