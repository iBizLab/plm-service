...
/**
 * 实体[PROJECT]处理逻辑[移动项目]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目更多设置移动项目

 */
class ProjectMove extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProjectMove.class)
    ...
    /**
     * 执行逻辑节点[准备更新项目参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
