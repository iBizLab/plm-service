...
/**
 * 实体[WORK_ITEM]处理逻辑[移动工作项]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项移动至其他的同类型项目
 */
class MoveWorkItem extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MoveWorkItem.class)
    ...
    /**
     * 执行逻辑节点[填充父工作项的标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[绑定传入的列表参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置移动参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[移动时子工作项的处理]，逻辑类型[DELOGIC]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
