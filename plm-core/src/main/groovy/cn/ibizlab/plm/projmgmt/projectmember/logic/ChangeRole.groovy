...
/**
 * 实体[PROJECT_MEMBER]处理逻辑[变更角色]运行时对象
 * 此代码用户功能扩展代码
 *
 * 批量设置角色身份（role_id）
 */
class ChangeRole extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChangeRole.class)
    ...
    /**
     * 执行逻辑节点[获取传递成员的参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[循环ID列表进行操作]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取传递的成员状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
