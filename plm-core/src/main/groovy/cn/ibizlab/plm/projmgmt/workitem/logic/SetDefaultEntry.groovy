...
/**
 * 实体[WORK_ITEM]处理逻辑[设置默认看板栏]运行时对象
 * 此代码用户功能扩展代码
 *
 * 选择看板后，自动填充所属看板下的的首个看板栏
 */
class SetDefaultEntry extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetDefaultEntry.class)
    ...
    /**
     * 执行逻辑节点[查询所属看板下的看板栏]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
