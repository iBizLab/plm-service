...
/**
 * 实体[STAGE]处理逻辑[删除发布阶段]运行时对象
 * 此代码用户功能扩展代码
 *
 * 删除发布阶段并替换
 */
class Del extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Del.class)
    ...
    /**
     * 执行逻辑节点[替换阶段同步属性]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
