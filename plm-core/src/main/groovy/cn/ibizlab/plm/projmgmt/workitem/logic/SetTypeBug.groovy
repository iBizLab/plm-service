...
/**
 * 实体[WORK_ITEM]处理逻辑[设置缺陷类型]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置当前工作项为缺陷类型
 */
class SetTypeBug extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetTypeBug.class)
    ...
    /**
     * 执行逻辑节点[准备项目ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置项目类别]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
