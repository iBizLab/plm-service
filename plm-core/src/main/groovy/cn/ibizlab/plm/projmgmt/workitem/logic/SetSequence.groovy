...
/**
 * 实体[WORK_ITEM]处理逻辑[设置初始排序值]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置初始排序值
 */
class SetSequence extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetSequence.class)
    ...
    /**
     * 执行逻辑节点[设置初始排序值]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
