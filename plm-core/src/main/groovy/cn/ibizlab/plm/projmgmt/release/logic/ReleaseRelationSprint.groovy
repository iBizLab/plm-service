...
/**
 * 实体[RELEASE]处理逻辑[发布关联迭代]运行时对象
 * 此代码用户功能扩展代码
 *
 * 发布关联迭代生成关联数据
 */
class ReleaseRelationSprint extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ReleaseRelationSprint.class)
    ...
    /**
     * 执行逻辑节点[绑定关联的迭代列表参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重置反向关系参数]，逻辑类型[RESETPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重置正向关系参数]，逻辑类型[RESETPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备关联参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
