...
/**
 * 实体[WORK_ITEM]处理逻辑[获取测试计划对应项目]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取测试计划对应项目
 */
class WorkItemTestPlanProject extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(WorkItemTestPlanProject.class)
    ...
    /**
     * 执行逻辑节点[绑定测试计划ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取TEST_PLAN关联项目]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[赋值ProjectId]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置默认缺陷类型]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置默认缺陷类型名称]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
