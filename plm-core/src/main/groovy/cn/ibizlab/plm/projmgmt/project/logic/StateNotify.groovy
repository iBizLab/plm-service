...
/**
 * 实体[PROJECT]处理逻辑[项目状态变更通知]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目状态变更时触发相应的通知消息
 */
class StateNotify extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(StateNotify.class)
