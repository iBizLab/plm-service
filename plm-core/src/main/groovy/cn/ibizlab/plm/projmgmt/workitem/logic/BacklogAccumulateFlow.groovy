...
/**
 * 实体[WORK_ITEM]处理逻辑[需求累计流图]运行时对象
 * 此代码用户功能扩展代码
 *
 * 报表需求累计流图数据源
 */
class BacklogAccumulateFlow extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(BacklogAccumulateFlow.class)
