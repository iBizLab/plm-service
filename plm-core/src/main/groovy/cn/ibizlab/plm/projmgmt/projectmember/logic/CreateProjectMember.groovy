...
/**
 * 实体[PROJECT_MEMBER]处理逻辑[新建项目成员]运行时对象
 * 此代码用户功能扩展代码
 *
 * 新建项目成员
 */
class CreateProjectMember extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreateProjectMember.class)
