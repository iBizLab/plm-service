...
/**
 * 实体[SPRINT]处理逻辑[开始迭代]运行时对象
 * 此代码用户功能扩展代码
 *
 * 开始迭代
 */
class StartSprint extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(StartSprint.class)
    ...
    /**
     * 执行逻辑节点[设置迭代状态（进行中）]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
