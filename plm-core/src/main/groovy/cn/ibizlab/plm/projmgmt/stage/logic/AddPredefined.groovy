package cn.ibizlab.plm.projmgmt.stage.logic
...
/**
 * 实体[STAGE]处理逻辑[添加系统预定义阶段]运行时对象
 * 此代码用户功能扩展代码
 *
 * 添加系统预定义阶段
 */
class AddPredefined extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddPredefined.class)
    ...
    /**
     * 执行逻辑节点[为各阶段生成数据]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
