...
/**
 * 实体[BASELINE_WORK_ITEM]处理逻辑[快照设立基线]运行时对象
 * 此代码用户功能扩展代码
 *
 * 快照设立基线
 */
class SnapshotSetBaseline extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SnapshotSetBaseline.class)
    ...
    /**
     * 执行逻辑节点[设值基线状态为打开]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
