...
/**
 * 实体[PROJECT]处理逻辑[获取项目进度]运行时对象
 * 此代码用户功能扩展代码
 *
 * 通过已完成工作项数量/所有工作项数量，计算出此项目进度
 */
class GetSchedule extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetSchedule.class)
