...
/**
 * 实体[WORK_ITEM]处理逻辑[分配负责人]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项分配负责人
 */
class ChangeAssignee extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChangeAssignee.class)
    ...
    /**
     * 执行逻辑节点[绑定选择人员参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置分配人信息]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
