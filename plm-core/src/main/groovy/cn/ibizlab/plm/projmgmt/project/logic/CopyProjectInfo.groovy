...
/**
 * 实体[PROJECT]处理逻辑[复制项目信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class CopyProjectInfo extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CopyProjectInfo.class)
