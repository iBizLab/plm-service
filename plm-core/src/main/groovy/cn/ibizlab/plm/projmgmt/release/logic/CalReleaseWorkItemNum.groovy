...
/**
 * 实体[RELEASE]处理逻辑[计算发布工作项数量]运行时对象
 * 此代码用户功能扩展代码
 *
 * 发布工作项数量计算
 */
class CalReleaseWorkItemNum extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CalReleaseWorkItemNum.class)
