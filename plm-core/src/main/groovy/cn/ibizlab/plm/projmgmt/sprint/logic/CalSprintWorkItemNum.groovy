...
/**
 * 实体[SPRINT]处理逻辑[计算迭代工作项数量]运行时对象
 * 此代码用户功能扩展代码
 *
 * 迭代工作项数量计算
 */
class CalSprintWorkItemNum extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CalSprintWorkItemNum.class)
    ...
    /**
     * 执行逻辑节点[查询迭代全部工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询迭代进行中工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询迭代已完成工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询迭代未开始工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
