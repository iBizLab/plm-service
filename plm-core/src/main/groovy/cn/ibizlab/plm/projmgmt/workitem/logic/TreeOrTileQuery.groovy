...
/**
 * 实体[WORK_ITEM]处理逻辑[工作项树状或平铺表格查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项树状或平铺表格查询
 */
class TreeOrTileQuery extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(TreeOrTileQuery.class)
