...
/**
 * 实体[WORK_ITEM]处理逻辑[规划工作项]运行时对象
 * 此代码用户功能扩展代码
 *
 * 规划选中工作项至指定发布
 */
class PlanWorkItem extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(PlanWorkItem.class)
    ...
    /**
     * 执行逻辑节点[绑定选择工作项数据]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重新建立工作项更新参数]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置规划信息]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
