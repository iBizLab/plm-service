...
/**
 * 实体[WORK_ITEM]处理逻辑[缺陷累计趋势查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 报表缺陷累计趋势报表数据源
 */
class DefectTotalTrend extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DefectTotalTrend.class)
    ...
    /**
     * 执行逻辑节点[查询每日新增缺陷累计]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
