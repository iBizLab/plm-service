...
/**
 * 实体[WORK_ITEM]处理逻辑[工作项分布]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项分布数据源
 */
class KanbanWorkItemDistribution extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(KanbanWorkItemDistribution.class)
    ...
    /**
     * 执行逻辑节点[查询工作项分布]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
