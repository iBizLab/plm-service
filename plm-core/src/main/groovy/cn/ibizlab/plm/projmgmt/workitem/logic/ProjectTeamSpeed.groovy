...
/**
 * 实体[WORK_ITEM]处理逻辑[团队速度]运行时对象
 * 此代码用户功能扩展代码
 *
 * 团队速度报表数据源
 */
class ProjectTeamSpeed extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProjectTeamSpeed.class)
