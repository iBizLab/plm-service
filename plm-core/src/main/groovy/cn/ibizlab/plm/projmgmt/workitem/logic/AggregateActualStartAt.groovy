...
/**
 * 实体[WORK_ITEM]处理逻辑[汇聚实际开始时间]运行时对象
 * 此代码用户功能扩展代码
 *
 * 实际开始时间变更时触发
 */
class AggregateActualStartAt extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AggregateActualStartAt.class)
    ...
    /**
     * 执行逻辑节点[设置父工作项过滤条件]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置父工作项]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置当前同级工作项过滤条件]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[调试当前级子数据]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取当前级的最小开始时间，赋值给父]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
