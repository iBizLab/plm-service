...
/**
 * 实体[PROJECT]处理逻辑[waterfall项目组件权限计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取waterfall项目组件权限
 */
class WaterfallProjectAddonAuthority extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(WaterfallProjectAddonAuthority.class)
