...
/**
 * 实体[PROJECT_MEMBER]处理逻辑[新建项目成员（移动端）]运行时对象
 * 此代码用户功能扩展代码
 *
 * 新建项目成员（移动端）
 */
class MobCreateProjectMember extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MobCreateProjectMember.class)
    ...
    /**
     * 执行逻辑节点[无USER_ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充项目成员属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
