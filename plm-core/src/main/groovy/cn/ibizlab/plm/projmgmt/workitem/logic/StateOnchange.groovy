...
/**
 * 实体[WORK_ITEM]处理逻辑[工作项状态变更附加逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项状态变更时触发相应的通知消息，同时生成流转记录
 */
class StateOnchange extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(StateOnchange.class)
    ...
    /**
     * 执行逻辑节点[工作项状态变换通知]，逻辑类型[DENOTIFY]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充流转记录属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[生成实际完成时间]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
