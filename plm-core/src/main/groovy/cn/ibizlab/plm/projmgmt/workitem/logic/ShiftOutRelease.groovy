...
/**
 * 实体[WORK_ITEM]处理逻辑[移出发布]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项移出发布
 */
class ShiftOutRelease extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ShiftOutRelease.class)
    ...
    /**
     * 执行逻辑节点[置空发布标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
