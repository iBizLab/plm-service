...
/**
 * 实体[WORK_ITEM]处理逻辑[修改时间]运行时对象
 * 此代码用户功能扩展代码
 *
 * 修改工作项的开始、结束时间
 */
class ChangeTime extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChangeTime.class)
    ...
    /**
     * 执行逻辑节点[设置时间参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
