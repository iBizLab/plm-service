...
/**
 * 实体[PROJECT]处理逻辑[使用模板创建项目]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class CreateFromTemplate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreateFromTemplate.class)
