...
/**
 * 实体[WORK_ITEM]处理逻辑[汇聚实际结束时间]运行时对象
 * 此代码用户功能扩展代码
 *
 * 实际结束时间变更时触发
 */
class AggregateActualEndAt extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AggregateActualEndAt.class)
