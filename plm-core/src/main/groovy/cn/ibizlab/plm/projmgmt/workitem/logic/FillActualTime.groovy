...
/**
 * 实体[WORK_ITEM]处理逻辑[填充实际开始/完成时间]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class FillActualTime extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillActualTime.class)
    ...
    /**
     * 执行逻辑节点[填充开始或结束时间]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
