package cn.ibizlab.plm.projmgmt.baselineworkitem.logic
...
/**
 * 实体[BASELINE_WORK_ITEM]处理逻辑[移入基线]运行时对象
 * 此代码用户功能扩展代码
 *
 * 将工作项移入对应基线
 */
class ShiftInBaseline extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ShiftInBaseline.class)
    ...
    /**
     * 执行逻辑节点[填充初始v1版本属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充关联目标版本标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[绑定所勾选的数据对象]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充关联属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[建立基线-工作项关联数据]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
