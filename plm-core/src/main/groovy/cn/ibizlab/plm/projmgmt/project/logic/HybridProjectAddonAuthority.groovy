...
/**
 * 实体[PROJECT]处理逻辑[hybrid项目组件权限计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取hybrid项目组件权限
 */
class HybridProjectAddonAuthority extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(HybridProjectAddonAuthority.class)
