...
/**
 * 实体[PROJECT]处理逻辑[负责人变更附加逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目负责人变更时触发相应的通知消息
 */
class AssigneeIdOnchange extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AssigneeIdOnchange.class)
    ...
    /**
     * 执行逻辑节点[项目变更负责人通知]，逻辑类型[DENOTIFY]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[项目分配负责人通知]，逻辑类型[DENOTIFY]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
