...
/**
 * 实体[WORK_ITEM]处理逻辑[状态类型变更附加逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 已完成时，填充完成时间
 */
class StateTypeOnchange extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(StateTypeOnchange.class)
    ...
    /**
     * 执行逻辑节点[置空完成时间]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[完成时间设置为当前时间]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[更新工作项完成时间]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
