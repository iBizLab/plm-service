...
/**
 * 实体[WORK_ITEM]处理逻辑[移出迭代]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项移出迭代
 */
class ShiftOutSprint extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ShiftOutSprint.class)
    ...
    /**
     * 执行逻辑节点[置空迭代标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
