package cn.ibizlab.plm.projmgmt.board.logic
...
/**
 * 实体[BOARD]处理逻辑[判断看板是否已删除]运行时对象
 * 此代码用户功能扩展代码
 *
 * 判断看板是否已删除，用于视图切换逻辑
 */
class CheckBoardIsDeleted extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CheckBoardIsDeleted.class)
