...
/**
 * 实体[WORK_ITEM]处理逻辑[需求树状或平铺表格查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 需求树状或平铺表格查询
 */
class RequirementTreeOrTileQuery extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RequirementTreeOrTileQuery.class)
