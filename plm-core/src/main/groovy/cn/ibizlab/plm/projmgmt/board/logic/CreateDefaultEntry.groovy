...
/**
 * 实体[BOARD]处理逻辑[生成默认看板栏和泳道]运行时对象
 * 此代码用户功能扩展代码
 *
 * 新建看板项目后，会附加生成出默认看板栏和泳道
 */
class CreateDefaultEntry extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreateDefaultEntry.class)
    ...
    /**
     * 执行逻辑节点[默认泳道名称]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[默认看板栏名称]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[建立默认需求池看板栏]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[建立默认设计看板栏]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[建立默认研发看板栏]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[建立默认测试看板栏]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[建立默认发布看板栏]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
