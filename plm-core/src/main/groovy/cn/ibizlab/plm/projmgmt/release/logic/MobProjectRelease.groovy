...
/**
 * 实体[RELEASE]处理逻辑[项目下发布（移动端）]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MobProjectRelease extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MobProjectRelease.class)
