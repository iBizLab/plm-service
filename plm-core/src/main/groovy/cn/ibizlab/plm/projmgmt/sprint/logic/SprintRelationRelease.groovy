...
/**
 * 实体[SPRINT]处理逻辑[迭代关联发布]运行时对象
 * 此代码用户功能扩展代码
 *
 * 迭代关联发布
 */
class SprintRelationRelease extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SprintRelationRelease.class)
    ...
    /**
     * 执行逻辑节点[绑定选中发布列表]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
