package cn.ibizlab.plm.projmgmt.sprintalteration.logic
...
/**
 * 实体[SPRINT_ALTERATION]处理逻辑[迭代变更统计]运行时对象
 * 此代码用户功能扩展代码
 *
 * 统计：启始，移入，移出迭代数量
 */
class RepChange extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RepChange.class)
