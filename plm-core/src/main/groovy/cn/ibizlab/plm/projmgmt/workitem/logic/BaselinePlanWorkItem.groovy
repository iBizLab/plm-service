...
/**
 * 实体[WORK_ITEM]处理逻辑[基线规划工作项数据查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 基线规划工作项时，填充工作项当前版本名称
 */
class BaselinePlanWorkItem extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(BaselinePlanWorkItem.class)
    ...
    /**
     * 执行逻辑节点[设置工作项版本id]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充默认版本信息]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
