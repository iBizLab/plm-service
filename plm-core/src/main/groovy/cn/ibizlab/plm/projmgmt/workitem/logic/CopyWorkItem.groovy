...
/**
 * 实体[WORK_ITEM]处理逻辑[复制工作项]运行时对象
 * 此代码用户功能扩展代码
 *
 * 复制工作项到其他的同类型项目
 */
class CopyWorkItem extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CopyWorkItem.class)
    ...
    /**
     * 执行逻辑节点[关联数据属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备关注参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备参数去复制子工作项]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
