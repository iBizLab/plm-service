...
/**
 * 实体[WORK_ITEM]处理逻辑[修复版本数据]运行时对象
 * 此代码用户功能扩展代码
 *
 * 修复初始版本数据
 */
class FixCommit extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FixCommit.class)
    ...
    /**
     * 执行逻辑节点[准备版本数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
