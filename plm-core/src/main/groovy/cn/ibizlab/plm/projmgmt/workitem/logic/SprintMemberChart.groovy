...
/**
 * 实体[WORK_ITEM]处理逻辑[迭代成员工作项图表查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 迭代成员工作项图表查询
 */
class SprintMemberChart extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SprintMemberChart.class)
    ...
    /**
     * 执行逻辑节点[查询此迭代中的工作项]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[负责人名称置为未分配]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
