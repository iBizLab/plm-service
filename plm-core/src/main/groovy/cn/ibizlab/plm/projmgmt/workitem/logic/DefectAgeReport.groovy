...
/**
 * 实体[WORK_ITEM]处理逻辑[缺陷年龄报告]运行时对象
 * 此代码用户功能扩展代码
 *
 * 报表缺陷年龄报告数据源

 */
class DefectAgeReport extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DefectAgeReport.class)
    ...
    /**
     * 执行逻辑节点[查询缺陷年龄报告]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
