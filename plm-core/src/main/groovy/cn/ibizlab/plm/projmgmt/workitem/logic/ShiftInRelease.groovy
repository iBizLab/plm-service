...
/**
 * 实体[WORK_ITEM]处理逻辑[移入发布]运行时对象
 * 此代码用户功能扩展代码
 *
 * 将工作项移入对应发布
 */
class ShiftInRelease extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ShiftInRelease.class)
    ...
    /**
     * 执行逻辑节点[填充发布标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[更新工作项的发布标识]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
