...
/**
 * 实体[WORK_ITEM]处理逻辑[子工作项取消关联]运行时对象
 * 此代码用户功能扩展代码
 *
 * 工作项取消关联子工作项
 */
class ChildDelRelation extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChildDelRelation.class)
    ...
    /**
     * 执行逻辑节点[将子工作项的父标识置空]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
