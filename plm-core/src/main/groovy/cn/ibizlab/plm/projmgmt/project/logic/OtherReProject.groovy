...
/**
 * 实体[PROJECT]处理逻辑[其他实体关联项目]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目实体关联操作，生成正向，反向关联数据
 */
class OtherReProject extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(OtherReProject.class)
    ...
    /**
     * 执行逻辑节点[填充关联参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
