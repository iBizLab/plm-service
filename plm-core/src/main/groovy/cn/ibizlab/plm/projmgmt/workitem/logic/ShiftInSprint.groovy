...
/**
 * 实体[WORK_ITEM]处理逻辑[移入迭代]运行时对象
 * 此代码用户功能扩展代码
 *
 * 将工作项移入对应迭代
 */
class ShiftInSprint extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ShiftInSprint.class)
