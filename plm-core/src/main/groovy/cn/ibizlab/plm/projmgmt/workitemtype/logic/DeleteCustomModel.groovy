...
/**
 * 实体[WORK_ITEM_TYPE]处理逻辑[删除扩展模型]运行时对象
 * 此代码用户功能扩展代码
 *
 * 删除工作项类型绑定的扩展模型
 */
class DeleteCustomModel extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DeleteCustomModel.class)
    ...
    /**
     * 执行逻辑节点[获取主视图form]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
