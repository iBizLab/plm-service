...
/**
 * 实体[WORK_ITEM]处理逻辑[获取工作项类型]运行时对象
 * 此代码用户功能扩展代码
 *
 * 链接跳转工作项主视图前，获取工作项类型
 */
class GetWorkItemType extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetWorkItemType.class)
    ...
    /**
     * 执行逻辑节点[查询工作项类型]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
