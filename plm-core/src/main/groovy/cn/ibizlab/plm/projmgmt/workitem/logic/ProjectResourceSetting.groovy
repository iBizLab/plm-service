...
/**
 * 实体[WORK_ITEM]处理逻辑[项目资源成员设置]运行时对象
 * 此代码用户功能扩展代码
 *
 * 项目资源成员设置，默认设置容量/工作日
 */
class ProjectResourceSetting extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProjectResourceSetting.class)
    ...
    /**
     * 执行逻辑节点[准备资源组件过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取当前项目下的资源组件]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重新建立资源列表成员]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
