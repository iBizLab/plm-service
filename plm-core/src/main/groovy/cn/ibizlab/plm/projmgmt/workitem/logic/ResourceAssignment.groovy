...
/**
 * 实体[WORK_ITEM]处理逻辑[资源分配]运行时对象
 * 此代码用户功能扩展代码
 *
 * 资源分配下的工作项
 */
class ResourceAssignment extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ResourceAssignment.class)
    ...
    /**
     * 执行逻辑节点[获取MEMBERS中的USER_ID]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
