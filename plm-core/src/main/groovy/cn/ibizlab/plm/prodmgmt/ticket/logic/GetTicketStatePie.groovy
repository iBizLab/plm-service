...
/**
 * 实体[TICKET]处理逻辑[获取工单状态饼图]运行时对象
 * 此代码用户功能扩展代码
 *
 * 需求关联工单统计视图中的饼图进行使用
 */
class GetTicketStatePie extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetTicketStatePie.class)
