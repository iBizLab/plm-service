package cn.ibizlab.plm.prodmgmt.productplan.logic
...
/**
 * 实体[PRODUCT_PLAN]处理逻辑[排期关联需求]运行时对象
 * 此代码用户功能扩展代码
 *
 * 排期计划关联需求，生成正反向关联数据
 */
class ProductPlanRelationIdea extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProductPlanRelationIdea.class)
    ...
    /**
     * 执行逻辑节点[重新建立正向关联参数]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重新建立反向关联参数]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置关联参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
