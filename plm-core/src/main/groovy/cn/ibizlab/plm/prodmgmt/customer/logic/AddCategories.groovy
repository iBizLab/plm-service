...
/**
 * 实体[CUSTOMER]处理逻辑[添加至类别]运行时对象
 * 此代码用户功能扩展代码
 *
 * 添加客户类别操作
 */
class AddCategories extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddCategories.class)
    ...
    /**
     * 执行逻辑节点[获取选择类别信息参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置类别路径]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
