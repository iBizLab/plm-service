...
/**
 * 实体[PRODUCT_PLAN]处理逻辑[填充类别文本]运行时对象
 * 此代码用户功能扩展代码
 *
 * 填充类别对应文本
 */
class FillCategoriesName extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillCategoriesName.class)
