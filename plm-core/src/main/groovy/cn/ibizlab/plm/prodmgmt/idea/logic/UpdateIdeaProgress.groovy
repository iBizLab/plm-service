...
/**
 * 实体[IDEA]处理逻辑[更新需求进度]运行时对象
 * 此代码用户功能扩展代码
 *
 * 根据id更新需求的进度
 */
class UpdateIdeaProgress extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UpdateIdeaProgress.class)
