...
/**
 * 实体[PRODUCT_MEMBER]处理逻辑[新建产品成员（移动端）]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MobCreateProductMember extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MobCreateProductMember.class)
    ...
    /**
     * 执行逻辑节点[填充产品成员属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
