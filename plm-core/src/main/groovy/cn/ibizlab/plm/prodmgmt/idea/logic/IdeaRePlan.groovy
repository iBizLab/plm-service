...
/**
 * 实体[IDEA]处理逻辑[需求排期]运行时对象
 * 此代码用户功能扩展代码
 *
 * 需求排期，用户在排期内关联相应需求，生成正反向关联关系
 */
class IdeaRePlan extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(IdeaRePlan.class)
    ...
    /**
     * 执行逻辑节点[填充需要的属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
