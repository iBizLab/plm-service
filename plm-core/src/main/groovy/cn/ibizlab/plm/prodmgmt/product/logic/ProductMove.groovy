...
/**
 * 实体[PRODUCT]处理逻辑[产品移动]运行时对象
 * 此代码用户功能扩展代码
 *
 * 产品更多设置中移动产品
 */
class ProductMove extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProductMove.class)
    ...
    /**
     * 执行逻辑节点[准备更新项目数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
