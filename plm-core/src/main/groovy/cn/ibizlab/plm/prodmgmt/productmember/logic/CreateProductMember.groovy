...
/**
 * 实体[PRODUCT_MEMBER]处理逻辑[新建产品成员]运行时对象
 * 此代码用户功能扩展代码
 *
 * 新建产品成员
 */
class CreateProductMember extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreateProductMember.class)
