...
/**
 * 实体[PRODUCT_TAG]处理逻辑[获取关联的工单数量]运行时对象
 * 此代码用户功能扩展代码
 *
 * 在删除产品标签时，获取与之关联的工单数量。
 */
class GetConProductTag extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetConProductTag.class)
    ...
    /**
     * 执行逻辑节点[传递工单数量]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[添加工单数量提醒内容]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
