...
/**
 * 实体[IDEA]处理逻辑[需求移动]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移动需求至其他位置（修改需求的所属产品，重新生成编号）
 */
class IdeaMove extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(IdeaMove.class)
    ...
    /**
     * 执行逻辑节点[填入移动产品ID，置空ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[修改需要移动的需求]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
