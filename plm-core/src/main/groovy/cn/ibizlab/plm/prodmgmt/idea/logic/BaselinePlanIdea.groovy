...
/**
 * 实体[IDEA]处理逻辑[基线规划需求数据查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 基线规划需求时，填充需求当前版本名称
 */
class BaselinePlanIdea extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(BaselinePlanIdea.class)
    ...
    /**
     * 执行逻辑节点[获取所选需求的版本ID信息]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备版本过滤器]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充当前版本名称]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充默认版本参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
