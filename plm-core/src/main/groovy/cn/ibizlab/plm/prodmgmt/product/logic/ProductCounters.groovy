...
/**
 * 实体[PRODUCT]处理逻辑[产品关联分页计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 计算关系分页下事件的条数
 */
class ProductCounters extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProductCounters.class)
    ...
    /**
     * 执行逻辑节点[查询产品关联需求数量]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
