...
/**
 * 实体[PRODUCT_MEMBER]处理逻辑[变更职位]运行时对象
 * 此代码用户功能扩展代码
 *
 * 批量设置角色身份（position_id）
 */
class ChangePosition extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChangePosition.class)
