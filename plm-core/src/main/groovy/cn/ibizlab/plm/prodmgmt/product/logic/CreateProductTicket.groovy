...
/**
 * 实体[PRODUCT]处理逻辑[生成产品工单类型]运行时对象
 * 此代码用户功能扩展代码
 *
 * 产品建立时将工单类型中is_system=1的数据同步至产品工单类型中
 */
class CreateProductTicket extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreateProductTicket.class)
    ...
    /**
     * 执行逻辑节点[查询is_system为1的数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询工单类型数据]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置工单类型参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
