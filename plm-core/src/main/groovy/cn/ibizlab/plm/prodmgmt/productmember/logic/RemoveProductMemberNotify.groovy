package cn.ibizlab.plm.prodmgmt.productmember.logic
...
/**
 * 实体[PRODUCT_MEMBER]处理逻辑[移除产品成员通知]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移除产品成员时向对应用户发送通知消息
 */
class RemoveProductMemberNotify extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveProductMemberNotify.class)
