...
/**
 * 实体[PRODUCT]处理逻辑[产品组件权限计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取产品组件权限
 */
class ProductAddonAuthority extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProductAddonAuthority.class)
