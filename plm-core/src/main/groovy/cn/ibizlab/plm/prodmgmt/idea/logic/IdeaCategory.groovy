...
/**
 * 实体[IDEA]处理逻辑[获取默认模块]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取需求的默认模块
 */
class IdeaCategory extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(IdeaCategory.class)
    ...
    /**
     * 执行逻辑节点[设置category_id]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取category]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置category_name]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
