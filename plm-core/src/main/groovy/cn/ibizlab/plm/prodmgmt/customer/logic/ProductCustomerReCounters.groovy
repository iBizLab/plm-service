...
/**
 * 实体[CUSTOMER]处理逻辑[产品客户关联分页计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 产品下的客户主视图的分页计数器数据来源
 */
class ProductCustomerReCounters extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProductCustomerReCounters.class)
