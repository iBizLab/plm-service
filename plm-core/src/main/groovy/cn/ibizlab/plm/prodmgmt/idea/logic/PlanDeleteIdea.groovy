...
/**
 * 实体[IDEA]处理逻辑[计划取消关联需求]运行时对象
 * 此代码用户功能扩展代码
 *
 * 排期（计划）内取消关联需求，删除正反向关联数据
 */
class PlanDeleteIdea extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(PlanDeleteIdea.class)
    ...
    /**
     * 执行逻辑节点[拼接正反关联对象的主键]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
