package cn.ibizlab.plm.prodmgmt.baselineidea.logic
...
/**
 * 实体[BASELINE_IDEA]处理逻辑[基线对比数据查询]运行时对象
 * 此代码用户功能扩展代码
 *
...
class BaselineComparison extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[获取当前基线下产品需求]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取对比基线下的产品需求]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取最新版本产品需求]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
