...
class ProductDTO extends GroovyDTO<ProductDTO> {
     ...
     * @param val
     */
    ProductDTO setIdentifier(String identifier) {
     ...
     * @param val
     */
    ProductDTO setVisibility(String visibility) {
     ...
     * @param val
     */
    ProductDTO setColor(String color) {
        this.color = color
        return this
    }
     ...
     * @param val
     */
    ProductDTO setIsArchived(Integer isArchived) {
     ...
     * @param val
     */
    ProductDTO setIsDeleted(Integer isDeleted) {
     ...
     * @param val
     */
    ProductDTO setIsFavorite(String isFavorite) {
     ...
     * @param val
     */
    ProductDTO setMembers(List<ProductMemberDTO> members) {
     ...
     * @param val
     */
    ProductDTO setScopeType(String scopeType) {
