...
/**
 * 实体[CUSTOMER]处理逻辑[其他实体关联客户]运行时对象
 * 此代码用户功能扩展代码
 *
 * 客户实体的关联操作，生成正向，反向关联数据
 */
class OthersRelationCustomer extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(OthersRelationCustomer.class)
    ...
    /**
     * 执行逻辑节点[选中列表数据绑定至变量]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重置正向关联对象]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重置反向关联对象]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
