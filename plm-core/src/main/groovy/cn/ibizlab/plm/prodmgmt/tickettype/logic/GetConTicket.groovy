package cn.ibizlab.plm.prodmgmt.tickettype.logic
...
/**
 * 实体[TICKET_TYPE]处理逻辑[获取关联的工单]运行时对象
 * 此代码用户功能扩展代码
 *
 * 在删除工单类型时，获取与之关联的工单数量以及提示信息。
 */
class GetConTicket extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetConTicket.class)
    ...
    /**
     * 执行逻辑节点[查询所关联的工单数量]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充工单提示默认值]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
