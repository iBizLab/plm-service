...
/**
 * 实体[IDEA]处理逻辑[产品需求关联分页计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 计算分页下关联事项的条数
 */
class ProductIdeaReCounters extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProductIdeaReCounters.class)
    ...
    /**
     * 执行逻辑节点[需求关联工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[需求关联测试用例]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置需求主键]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取产品需求当前版本]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
