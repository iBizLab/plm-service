package cn.ibizlab.plm.prodmgmt.reviewcontentidea.logic
...
/**
 * 实体[REVIEW_CONTENT_IDEA]处理逻辑[评审结果条数]运行时对象
 * 此代码用户功能扩展代码
 *
 * 查询评审结果总条数与已评审条数
 */
class ReviewContentTotal extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ReviewContentTotal.class)
    ...
    /**
     * 执行逻辑节点[查询评审结果总条数与已评审条数]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
