...
/**
 * 实体[TICKET]处理逻辑[分配负责人]运行时对象
 * 此代码用户功能扩展代码
 *
 * 分配工单负责人，修改负责人属性
 */
class AllocatePerson extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AllocatePerson.class)
    ...
    /**
     * 执行逻辑节点[绑定选中负责人参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充负责人]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
