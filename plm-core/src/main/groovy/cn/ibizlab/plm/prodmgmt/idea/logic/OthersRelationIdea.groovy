...
/**
 * 实体[IDEA]处理逻辑[其他实体关联需求]运行时对象
 * 此代码用户功能扩展代码
 *
 * 需求实体的关联操作，生成正向，反向关联数据
 */
class OthersRelationIdea extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(OthersRelationIdea.class)
    ...
    /**
     * 执行逻辑节点[绑定选中需求参数列表]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重新建立正向关系参数]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重新建立反向关系参数]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充正反向关系参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
