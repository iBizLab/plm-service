...
/**
 * 实体[PRODUCT]处理逻辑[产品关联空间]运行时对象
 * 此代码用户功能扩展代码
 *
 * 产品关联空间操作，生成正反向关联数据
 */
class ProductReSpace extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProductReSpace.class)
    ...
    /**
     * 执行逻辑节点[设置正/反向关联参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
