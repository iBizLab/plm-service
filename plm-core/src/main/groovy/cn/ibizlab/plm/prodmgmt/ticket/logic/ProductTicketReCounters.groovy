...
/**
 * 实体[TICKET]处理逻辑[产品工单关联分页计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 计算分页下关联事项的条数
 */
class ProductTicketReCounters extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProductTicketReCounters.class)
    ...
    /**
     * 执行逻辑节点[工单关联工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
