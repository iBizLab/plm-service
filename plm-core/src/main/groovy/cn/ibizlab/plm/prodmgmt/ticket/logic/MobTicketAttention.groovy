...
/**
 * 实体[TICKET]处理逻辑[工单关注（移动端）]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MobTicketAttention extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MobTicketAttention.class)
