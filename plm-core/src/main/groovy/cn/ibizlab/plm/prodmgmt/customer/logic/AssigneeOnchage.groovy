...
/**
 * 实体[CUSTOMER]处理逻辑[变更负责人附加逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 客户负责人变更时触发相应的通知消息
 */
class AssigneeOnchage extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AssigneeOnchage.class)
    ...
    /**
     * 执行逻辑节点[客户分配负责人通知]，逻辑类型[DENOTIFY]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备更新人和更新时间参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
