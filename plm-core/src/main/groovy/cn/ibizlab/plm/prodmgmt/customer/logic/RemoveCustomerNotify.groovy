...
/**
 * 实体[CUSTOMER]处理逻辑[删除客户发送通知]运行时对象
 * 此代码用户功能扩展代码
 *
 * 根据客户标识触发删除客户发送通知
 */
class RemoveCustomerNotify extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveCustomerNotify.class)
    ...
    /**
     * 执行逻辑节点[获取当前操作人]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
