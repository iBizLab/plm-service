...
/**
 * 实体[TICKET]处理逻辑[客户取消关联工单]运行时对象
 * 此代码用户功能扩展代码
 *
 * 客户取消关联工单操作
 */
class CustomerDelTicket extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CustomerDelTicket.class)
    ...
    /**
     * 执行逻辑节点[工单中的客户标识置空]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
