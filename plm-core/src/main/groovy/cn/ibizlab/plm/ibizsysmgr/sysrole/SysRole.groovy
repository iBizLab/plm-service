...
class SysRole extends GroovyDataEntityRuntime<SysRole,SysRoleDTO,SysRoleFilterDTO> {
    ...
    def create(SysRoleDTO dto) throws Throwable {
    ...
    def update(SysRoleDTO dto) throws Throwable {
    ...
    def getDraft(SysRoleDTO dto) throws Throwable {
    ...
    def checkKey(SysRoleDTO dto) throws Throwable {
    ...
    def save(SysRoleDTO dto) throws Throwable {
    ...
    def fetchDefault(SysRoleFilterDTO context) throws Throwable {
