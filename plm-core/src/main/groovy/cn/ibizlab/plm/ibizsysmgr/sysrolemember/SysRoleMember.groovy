...
class SysRoleMember extends GroovyDataEntityRuntime<SysRoleMember,SysRoleMemberDTO,SysRoleMemberFilterDTO> {
    ...
    def create(SysRoleMemberDTO dto) throws Throwable {
    ...
    def update(SysRoleMemberDTO dto) throws Throwable {
    ...
    def getDraft(SysRoleMemberDTO dto) throws Throwable {
    ...
    def checkKey(SysRoleMemberDTO dto) throws Throwable {
    ...
    def save(SysRoleMemberDTO dto) throws Throwable {
    ...
    def fetchDefault(SysRoleMemberFilterDTO context) throws Throwable {
