...
/**
 * 实体[RUN]处理逻辑[每日执行用例趋势]运行时对象
 * 此代码用户功能扩展代码
 *
 * 报表每日执行用例趋势数据源
 */
class RunDailyTendencies extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RunDailyTendencies.class)
    ...
    /**
     * 执行逻辑节点[每日执行用例趋势]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
