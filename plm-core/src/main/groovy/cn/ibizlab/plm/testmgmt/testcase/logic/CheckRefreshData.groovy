...
/**
 * 实体[TEST_CASE]处理逻辑[检查更新数据]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class CheckRefreshData extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CheckRefreshData.class)
    ...
    /**
     * 执行逻辑节点[调试逻辑参数ctx]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
