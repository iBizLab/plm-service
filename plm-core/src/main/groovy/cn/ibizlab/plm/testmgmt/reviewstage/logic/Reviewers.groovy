package cn.ibizlab.plm.testmgmt.reviewstage.logic
...
/**
 * 实体[REVIEW_STAGE]处理逻辑[参与评审人]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class Reviewers extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Reviewers.class)
