...
/**
 * 实体[TEST_PLAN]处理逻辑[计划操作标识业务计算逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 计划操作标识业务计算逻辑
 */
class OpprivLogic extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(OpprivLogic.class)
    ...
    /**
     * 执行逻辑节点[不允许修改]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
