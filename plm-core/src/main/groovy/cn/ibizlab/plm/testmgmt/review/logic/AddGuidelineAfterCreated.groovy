...
/**
 * 实体[REVIEW]处理逻辑[创建后附加评审规则]运行时对象
 * 此代码用户功能扩展代码
 *
 * 在创建评审后，自动获取规则的值并赋予
 */
class AddGuidelineAfterCreated extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[获取规则ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置阶段数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置默认关注人]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
