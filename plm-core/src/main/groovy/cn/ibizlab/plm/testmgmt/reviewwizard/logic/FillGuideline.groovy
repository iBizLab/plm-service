...
/**
 * 实体[REVIEW_WIZARD]处理逻辑[填充评审规则]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取评审规则并返回
 */
class FillGuideline extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillGuideline.class)
    ...
    /**
     * 执行逻辑节点[测试库参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询当前指定类型的规则]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置返回的guideline_id]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
