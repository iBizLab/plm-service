...
/**
 * 实体[REVIEW_CONTENT]处理逻辑[生成评审结果]运行时对象
 * 此代码用户功能扩展代码
 *
 * 创建后自动生成评审结果
 */
class GenerateReviewResults extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GenerateReviewResults.class)
    ...
    /**
     * 执行逻辑节点[获取所属测试库设置流程准则的过滤参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取流程准则信息，设置评审阶段过滤参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[绑定评审阶段数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[循环评审阶段]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置新建的评审结果数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[创建前的评审结果]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
