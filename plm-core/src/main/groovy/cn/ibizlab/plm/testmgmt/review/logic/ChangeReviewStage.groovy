...
/**
 * 实体[REVIEW]处理逻辑[变更评审内阶段]运行时对象
 * 此代码用户功能扩展代码
 *
 * 变更评审内阶段
 */
class ChangeReviewStage extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChangeReviewStage.class)
    ...
    /**
     * 执行逻辑节点[设置阶段集合参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[评审列表返回评审]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[更新前评审数据]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置评审人]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[附加到评审列表]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
