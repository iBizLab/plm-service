...
/**
 * 实体[TEST_CASE]处理逻辑[测试用例规划分析]运行时对象
 * 此代码用户功能扩展代码
 *
 * 报表测试用例规划分析数据源
 */
class ProgramAnalyze extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProgramAnalyze.class)
    ...
    /**
     * 执行逻辑节点[测试用例规划分析]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
