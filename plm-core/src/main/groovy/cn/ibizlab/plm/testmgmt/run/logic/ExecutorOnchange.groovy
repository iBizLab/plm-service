...
/**
 * 实体[RUN]处理逻辑[执行人变更附加逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 执行用例执行人变更时触发相应的通知消息
 */
class ExecutorOnchange extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ExecutorOnchange.class)
