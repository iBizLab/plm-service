...
/**
 * 实体[RUN]处理逻辑[通过迭代规划计划]运行时对象
 * 此代码用户功能扩展代码
 *
 * 通过迭代规划计划
 */
class ProgramPlanBySprint extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProgramPlanBySprint.class)
    ...
    /**
     * 执行逻辑节点[查询迭代下工作项]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[返回未规划数据]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
