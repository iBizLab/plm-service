...
/**
 * 实体[RUN]处理逻辑[设置执行人]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置当前执行用例执行人
 */
class SetExecutor extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetExecutor.class)
    ...
    /**
     * 执行逻辑节点[填充执行人]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
