package cn.ibizlab.plm.testmgmt.guideline.logic
...
/**
 * 实体[GUIDELINE]处理逻辑[生成阶段排序值]运行时对象
 * 此代码用户功能扩展代码
 *
 * 生成阶段排序值
 */
class FillStageOrder extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillStageOrder.class)
