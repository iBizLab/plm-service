...
/**
 * 实体[TEST_PLAN]处理逻辑[结束测试]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置测试计划状态为结束
 */
class EndTestPlan extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(EndTestPlan.class)
    ...
    /**
     * 执行逻辑节点[设置状态值（completed）]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
