...
/**
 * 实体[TEST_CASE]处理逻辑[设置重要程度]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置测试用例的重要程度属性
 */
class SetLevel extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetLevel.class)
    ...
    /**
     * 执行逻辑节点[设置重要程度参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
