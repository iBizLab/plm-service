...
/**
 * 实体[RUN]处理逻辑[附加用例步骤]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取用例步骤，并返回
 */
class AddSteps extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddSteps.class)
    ...
    /**
     * 执行逻辑节点[填充case的主键]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充Run中的用例步骤]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
