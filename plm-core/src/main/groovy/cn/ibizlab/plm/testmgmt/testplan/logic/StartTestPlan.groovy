...
/**
 * 实体[TEST_PLAN]处理逻辑[开始测试]运行时对象
 * 此代码用户功能扩展代码
 *
 * 测试计划开始测试
 */
class StartTestPlan extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(StartTestPlan.class)
    ...
    /**
     * 执行逻辑节点[设置状态值（in_progress）]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
