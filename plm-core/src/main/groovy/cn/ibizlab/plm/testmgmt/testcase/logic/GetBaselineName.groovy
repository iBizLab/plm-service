...
/**
 * 实体[TEST_CASE]处理逻辑[获取基线名称]运行时对象
 * 此代码用户功能扩展代码
 *
 * 用例主视图获取所属基线
 */
class GetBaselineName extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetBaselineName.class)
    ...
    /**
     * 执行逻辑节点[准备关联过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取此基线引入的基线]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[绑定最近移入的基线]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充基线标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[将基线名称填充至工作项对象中]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
