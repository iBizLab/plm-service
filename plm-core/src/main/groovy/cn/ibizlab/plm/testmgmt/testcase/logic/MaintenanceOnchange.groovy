...
/**
 * 实体[TEST_CASE]处理逻辑[维护人变更附加逻辑]运行时对象
 * 此代码用户功能扩展代码
 *
 * 测试用例维护人变更时触发相应的通知消息
 */
class MaintenanceOnchange extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MaintenanceOnchange.class)
    ...
    /**
     * 执行逻辑节点[取消分配维护人通知]，逻辑类型[DENOTIFY]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
