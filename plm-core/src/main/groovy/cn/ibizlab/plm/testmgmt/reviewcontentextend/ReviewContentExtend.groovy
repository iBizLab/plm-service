...
class ReviewContentExtend extends GroovyDataEntityRuntime<ReviewContentExtend,ReviewContentExtendDTO,ReviewContentExtendFilterDTO> {
    ...
    def create(ReviewContentExtendDTO dto) throws Throwable {
    ...
    def update(ReviewContentExtendDTO dto) throws Throwable {
    ...
    def getDraft(ReviewContentExtendDTO dto) throws Throwable {
    ...
    def checkKey(ReviewContentExtendDTO dto) throws Throwable {
    ...
    def save(ReviewContentExtendDTO dto) throws Throwable {
    ...
    def fetchDefault(ReviewContentExtendFilterDTO context) throws Throwable {
