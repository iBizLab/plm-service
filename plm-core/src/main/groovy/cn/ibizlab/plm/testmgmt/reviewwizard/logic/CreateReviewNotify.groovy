...
/**
 * 实体[REVIEW_WIZARD]处理逻辑[评审新建通知]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class CreateReviewNotify extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreateReviewNotify.class)
