...
/**
 * 实体[REVIEW]处理逻辑[撤销评审]运行时对象
 * 此代码用户功能扩展代码
 *
 * 撤销评审，并重置评审结果
 */
class RepealReview extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RepealReview.class)
    ...
    /**
     * 执行逻辑节点[清空提交人、状态、时间]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[循环阶段数据]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置阶段为未开始]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取评审阶段结果]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置评审状态为为评审]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
