package cn.ibizlab.plm.testmgmt.reviewwizard.logic
...
/**
 * 实体[REVIEW_WIZARD]处理逻辑[创建后附加评审规则]运行时对象
 * 此代码用户功能扩展代码
 *
 *  进行中
 */
class AddGuidelineAfterCreated extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddGuidelineAfterCreated.class)
    ...
    /**
     * 执行逻辑节点[获取流程准则ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取步骤及类型]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
