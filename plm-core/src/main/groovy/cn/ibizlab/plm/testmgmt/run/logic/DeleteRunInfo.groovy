...
/**
 * 实体[RUN]处理逻辑[移除用例相关信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * 在执行remove操作之前，移除相关的执行用例信息
 */
class DeleteRunInfo extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DeleteRunInfo.class)
    ...
    /**
     * 执行逻辑节点[移除执行用例关联附件]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[移除执行用例关联缺陷]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
