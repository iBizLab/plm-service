...
/**
 * 实体[LIBRARY]处理逻辑[移动测试库]运行时对象
 * 此代码用户功能扩展代码
 *
 * 更新测试库的所属、可见范围
 */
class MoveLibrary extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MoveLibrary.class)
    ...
    /**
     * 执行逻辑节点[绑定要更改的测试库数据]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[组装待更新的测试库数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
