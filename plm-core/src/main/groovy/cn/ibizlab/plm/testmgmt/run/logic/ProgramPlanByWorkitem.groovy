...
/**
 * 实体[RUN]处理逻辑[通过工作项规划计划]运行时对象
 * 此代码用户功能扩展代码
 *
 * 通过工作项规划计划
 */
class ProgramPlanByWorkitem extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ProgramPlanByWorkitem.class)
