...
/**
 * 实体[RUN]处理逻辑[测试计划对比分析]运行时对象
 * 此代码用户功能扩展代码
 *
 * 报表测试计划对比分析数据源
 */
class PlanComparAtiveAnalysis extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(PlanComparAtiveAnalysis.class)
    ...
    /**
     * 执行逻辑节点[测试计划对比分析]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
