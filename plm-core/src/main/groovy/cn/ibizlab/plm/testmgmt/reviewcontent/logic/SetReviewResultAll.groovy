...
/**
 * 实体[REVIEW_CONTENT]处理逻辑[设置评审结果（批）]运行时对象
 * 此代码用户功能扩展代码
 *
 * 批量进行评审
 */
class SetReviewResultAll extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetReviewResultAll.class)
    ...
    /**
     * 执行逻辑节点[获取表单内容，添加过滤条件]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置更新参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
