...
/**
 * 实体[LIBRARY_MEMBER]处理逻辑[移除测试库成员通知]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移除测试库成员时向对应用户发送通知消息
 */
class RemoveLibraryMemberNotify extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RemoveLibraryMemberNotify.class)
    ...
    /**
     * 执行逻辑节点[获取测试库成员数据]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充当前操作时间]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[移除测试库成员通知]，逻辑类型[DENOTIFY]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
