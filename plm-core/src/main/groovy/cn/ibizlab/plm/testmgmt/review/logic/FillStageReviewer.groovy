...
/**
 * 实体[REVIEW]处理逻辑[填充阶段评审人]运行时对象
 * 此代码用户功能扩展代码
 *
 * 填充阶段评审人
 */
class FillStageReviewer extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillStageReviewer.class)
    ...
    /**
     * 执行逻辑节点[设置过滤参数及用户ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[循环符合条件的成员信息]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
