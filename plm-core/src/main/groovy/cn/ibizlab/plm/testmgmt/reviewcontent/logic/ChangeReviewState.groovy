...
/**
 * 实体[REVIEW_CONTENT]处理逻辑[变更评审状态]运行时对象
 * 此代码用户功能扩展代码
 *
 * 完成评审后变更测试用例的评审状态
 */
class ChangeReviewState extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChangeReviewState.class)
    ...
    /**
     * 执行逻辑节点[设置评审状态为通过]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置评审状态为拒绝]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取产品需求ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
