package cn.ibizlab.plm.testmgmt.reviewresult.logic
...
/**
 * 实体[REVIEW_RESULT]处理逻辑[设置评审结果]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置评审结果
 */
class SetResult extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetResult.class)
    ...
    /**
     * 执行逻辑节点[获取评审结果列表]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[输出当前循环的评审结果]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取当前评审阶段ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
