...
/**
 * 实体[RUN]处理逻辑[重置为未测]运行时对象
 * 此代码用户功能扩展代码
 *
 * 重置当前执行用例的执行状态为初始未测状态
 */
class ResetNotTest extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ResetNotTest.class)
    ...
    /**
     * 执行逻辑节点[获取选中的用例ID]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置当前循环用例的执行状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
