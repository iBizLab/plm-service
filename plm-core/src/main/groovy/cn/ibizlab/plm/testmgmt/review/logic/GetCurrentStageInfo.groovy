...
/**
 * 实体[REVIEW]处理逻辑[获取当前阶段信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取当前阶段信息，用于完成评审按钮使用
 */
class GetCurrentStageInfo extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetCurrentStageInfo.class)
    ...
    /**
     * 执行逻辑节点[设置评审阶段列表参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取未完成的评审内容数量]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
