...
/**
 * 实体[RUN]处理逻辑[批设置执行结果]运行时对象
 * 此代码用户功能扩展代码
 *
 * 批量设置执行用例的执行结果
 */
class BatchSaveRunHistory extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(BatchSaveRunHistory.class)
    ...
    /**
     * 执行逻辑节点[绑定选中数据对象]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置执行状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置执行结果]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
