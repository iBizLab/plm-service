...
/**
 * 实体[RUN]处理逻辑[获取实际工时]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取用例的实际工时
 */
class GetActualWorkload extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetActualWorkload.class)
    ...
    /**
     * 执行逻辑节点[获取已登记的工时]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
