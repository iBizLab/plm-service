...
/**
 * 实体[RUN]处理逻辑[执行用例关联分页计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * 计算分页下关联事项的条数
 */
class RunReCounters extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RunReCounters.class)
    ...
    /**
     * 执行逻辑节点[执行用例关联缺陷]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[执行用例结果附件]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
