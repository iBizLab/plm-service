...
/**
 * 实体[TEST_PLAN]处理逻辑[测试报告概览数据源]运行时对象
 * 此代码用户功能扩展代码
 *
 * 测试报告概览的数据源
 */
class TestPlanReportSurvey extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(TestPlanReportSurvey.class)
    ...
    /**
     * 执行逻辑节点[测试计划内用例数]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[测试计划用例覆盖率]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[测试计划用例通过率]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[测试计划内缺陷数]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[测试计划详情加入返回结果]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
