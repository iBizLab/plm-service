...
/**
 * 实体[TEST_CASE]处理逻辑[设置维护人]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置当前测试用例维护人
 */
class SetMaintenance extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetMaintenance.class)
    ...
    /**
     * 执行逻辑节点[绑定选中测试参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置测试维护人]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
