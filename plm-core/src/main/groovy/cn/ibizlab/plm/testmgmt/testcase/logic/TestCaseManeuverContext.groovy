...
/**
 * 实体[TEST_CASE]处理逻辑[测试用例活动情况]运行时对象
 * 此代码用户功能扩展代码
 *
 * 报表测试用例活动情况数据源
 */
class TestCaseManeuverContext extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(TestCaseManeuverContext.class)
    ...
    /**
     * 执行逻辑节点[ 测试用例活动情况]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
