...
/**
 * 实体[TEST_CASE]处理逻辑[其他实体关联用例]运行时对象
 * 此代码用户功能扩展代码
 *
 * 测试用例实体的关联操作，生成正向，反向关联数据
 */
class OthersRelationTestCase extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(OthersRelationTestCase.class)
