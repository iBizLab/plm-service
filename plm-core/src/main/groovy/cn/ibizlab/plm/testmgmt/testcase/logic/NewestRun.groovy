...
/**
 * 实体[TEST_CASE]处理逻辑[获取最近执行]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取当前测试用例的最近执行记录
 */
class NewestRun extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(NewestRun.class)
    ...
    /**
     * 执行逻辑节点[获取最近执行信息]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
