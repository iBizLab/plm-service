...
/**
 * 实体[TEST_CASE]处理逻辑[基线规划用例数据查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 基线规划用例时，填充用例当前版本名称
 */
class BaselinePlanCase extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(BaselinePlanCase.class)
    ...
    /**
     * 执行逻辑节点[准备版本参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
