...
/**
 * 实体[TEST_CASE]处理逻辑[选择用例模板]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取选中模板并返回详情
 */
class ChooseCaseTemplate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ChooseCaseTemplate.class)
    ...
    /**
     * 执行逻辑节点[获取选中数据ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
