...
/**
 * 实体[RUN]处理逻辑[测试用例最新执行结果]运行时对象
 * 此代码用户功能扩展代码
 *
 * 测试用例最新执行结果
 */
class CaseLatestExecuted extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CaseLatestExecuted.class)
    ...
    /**
     * 执行逻辑节点[设置执行结果查询过滤参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
