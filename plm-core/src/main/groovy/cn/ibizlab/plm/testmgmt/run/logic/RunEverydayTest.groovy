...
/**
 * 实体[RUN]处理逻辑[每日测试次数统计]运行时对象
 * 此代码用户功能扩展代码
 *
 * 报表每日测试次数统计数据源
 */
class RunEverydayTest extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RunEverydayTest.class)
    ...
    /**
     * 执行逻辑节点[每日测试次数统计]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
