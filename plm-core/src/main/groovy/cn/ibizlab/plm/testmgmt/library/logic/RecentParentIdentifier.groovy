...
/**
 * 实体[LIBRARY]处理逻辑[批量更新最近访问父标识]运行时对象
 * 此代码用户功能扩展代码
 *
 * 当测试库标识变更时，触发此逻辑，批量对最近访问的父标识进行更新
 */
class RecentParentIdentifier extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RecentParentIdentifier.class)
    ...
    /**
     * 执行逻辑节点[批量更新最近访问父级标识]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
