...
/**
 * 实体[TEST_CASE]处理逻辑[复制用例]运行时对象
 * 此代码用户功能扩展代码
 *
 * 复制测试用例
 */
class CopyTestCase extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CopyTestCase.class)
    ...
    /**
     * 执行逻辑节点[设置用例信息]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[置空附件ID及owner_id]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
