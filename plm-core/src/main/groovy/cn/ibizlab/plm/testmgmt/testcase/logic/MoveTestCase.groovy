...
/**
 * 实体[TEST_CASE]处理逻辑[移动用例]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移动用例至其他位置（修改用例的所属测试库，重新生成编号）
 */
class MoveTestCase extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MoveTestCase.class)
    ...
    /**
     * 执行逻辑节点[重新建立测试用例参数]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置当前用例参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置用例模块标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
