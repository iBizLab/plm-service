...
/**
 * 实体[RUN]处理逻辑[添加计划执行用例]运行时对象
 * 此代码用户功能扩展代码
 *
 * 将测试计划主键置空并生成执行用例
 */
class CreatePlanRun extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreatePlanRun.class)
