...
/**
 * 实体[REVIEW_CONTENT]处理逻辑[开始评审]运行时对象
 * 此代码用户功能扩展代码
 *
 * 开启当前阶段评审
 */
class StartReview extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(StartReview.class)
    ...
    /**
     * 执行逻辑节点[设置阶段数据参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
