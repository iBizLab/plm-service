...
/**
 * 实体[TEST_CASE]处理逻辑[设置评审状态]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置测试用例的评审状态属性
 */
class SetState extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetState.class)
    ...
    /**
     * 执行逻辑节点[设置用例状态参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
