...
/**
 * 实体[TEST_CASE]处理逻辑[填充最近执行]运行时对象
 * 此代码用户功能扩展代码
 *
 * 填充最近执行
 */
class FillLatestExecuted extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillLatestExecuted.class)
