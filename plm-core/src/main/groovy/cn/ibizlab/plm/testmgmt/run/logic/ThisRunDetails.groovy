...
/**
 * 实体[RUN]处理逻辑[获取当前用例详情]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取当前执行用例详情信息
 */
class ThisRunDetails extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ThisRunDetails.class)
    ...
    /**
     * 执行逻辑节点[获取最近执行的一条数据]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
