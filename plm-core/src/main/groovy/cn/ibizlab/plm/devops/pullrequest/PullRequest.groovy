...
class PullRequest extends GroovyDataEntityRuntime<PullRequest,PullRequestDTO,PullRequestFilterDTO> {
    ...
    def create(PullRequestDTO dto) throws Throwable {
    ...
    def update(PullRequestDTO dto) throws Throwable {
    ...
    def getDraft(PullRequestDTO dto) throws Throwable {
    ...
    def checkKey(PullRequestDTO dto) throws Throwable {
    ...
    def save(PullRequestDTO dto) throws Throwable {
    ...
    def fetchDefault(PullRequestFilterDTO context) throws Throwable {
