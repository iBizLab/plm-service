...
/**
 * 实体[DISCUSS_TOPIC]处理逻辑[自动创建人员]运行时对象
 * 此代码用户功能扩展代码
 *
...
class AutoCreateMembers extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[准备团队成员查询参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取此团队下的成员]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重置话题成员对象]，逻辑类型[RESETPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充话题成员属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
