...
/**
 * 实体[DISCUSS_REPLY]处理逻辑[回复下删除评论]运行时对象
 * 此代码用户功能扩展代码
 *
 * 回复下删除评论
 */
class DelComment extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DelComment.class)
