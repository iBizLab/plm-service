...
/**
 * 实体[DISCUSS_REPLY]处理逻辑[添加回复]运行时对象
 * 此代码用户功能扩展代码
 *
 * 添加回复
 */
class AddReply extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AddReply.class)
