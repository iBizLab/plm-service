package cn.ibizlab.plm.team.discussreply.logic
...
/**
 * 实体[DISCUSS_REPLY]处理逻辑[回复下修改评论]运行时对象
 * 此代码用户功能扩展代码
 *
 * 回复下修改评论
 */
class UpdateComment extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UpdateComment.class)
    ...
    /**
     * 执行逻辑节点[填充评论属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
