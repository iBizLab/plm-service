...
/**
 * 实体[DISCUSS_POST]处理逻辑[获取讨论权限]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取讨论权限，创建人等于自己，则srfreadonly为false。否则直接结束，不返回数据
 */
class GetPostAuth extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetPostAuth.class)
