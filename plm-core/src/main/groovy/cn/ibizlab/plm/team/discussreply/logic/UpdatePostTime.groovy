...
/**
 * 实体[DISCUSS_REPLY]处理逻辑[更新讨论时间]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class UpdatePostTime extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UpdatePostTime.class)
