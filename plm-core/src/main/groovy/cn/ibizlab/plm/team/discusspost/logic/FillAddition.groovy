...
/**
 * 实体[DISCUSS_POST]处理逻辑[填充附加数据]运行时对象
 * 此代码用户功能扩展代码
 *
 * 查询创建人创建的讨论和回复数量；此讨论下的参与者
 */
class FillAddition extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillAddition.class)
    ...
    /**
     * 执行逻辑节点[创建的讨论数量]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[创建的回复数量]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
