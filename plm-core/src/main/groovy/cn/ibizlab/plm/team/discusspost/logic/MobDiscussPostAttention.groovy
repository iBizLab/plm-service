...
/**
 * 实体[DISCUSS_POST]处理逻辑[讨论关注（移动端）]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MobDiscussPostAttention extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MobDiscussPostAttention.class)
