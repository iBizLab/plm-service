...
/**
 * 实体[DISCUSS_REPLY]处理逻辑[删除回复]运行时对象
 * 此代码用户功能扩展代码
 *
 * 删除回复
 */
class DelReply extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DelReply.class)
    ...
    /**
     * 执行逻辑节点[计算此回复下的评论条数]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[删除回复下的评论数据]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
