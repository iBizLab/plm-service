...
/**
 * 实体[DISCUSS_TOPIC]处理逻辑[取消星标]运行时对象
 * 此代码用户功能扩展代码
 *
 * 话题取消星标
 */
class UnFavorite extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UnFavorite.class)
