package cn.ibizlab.plm.team.discusstopic.logic
...
/**
 * 实体[DISCUSS_TOPIC]处理逻辑[变更管理员角色（移动端）]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MobChangeAdminRole extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MobChangeAdminRole.class)
