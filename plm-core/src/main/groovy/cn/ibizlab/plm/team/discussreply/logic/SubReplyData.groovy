...
/**
 * 实体[DISCUSS_REPLY]处理逻辑[子回复数据]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置回复的子回复
 */
class SubReplyData extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SubReplyData.class)
    ...
    /**
     * 执行逻辑节点[设置子回复过滤器]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
