...
/**
 * 实体[DISCUSS_REPLY]处理逻辑[编辑回复]运行时对象
 * 此代码用户功能扩展代码
 *
 * 编辑回复
 */
class EditReply extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(EditReply.class)
    ...
    /**
     * 执行逻辑节点[填充回复内容]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
