...
/**
 * 实体[DISCUSS_MEMBER]处理逻辑[新建话题成员（移动端）]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MobCreateTopicMember extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MobCreateTopicMember.class)
