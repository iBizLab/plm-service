...
/**
 * 实体[DISCUSS_POST]处理逻辑[添加评论]运行时对象
 * 此代码用户功能扩展代码
 *
 * 添加讨论中的评论信息
 */
class SendComment extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SendComment.class)
