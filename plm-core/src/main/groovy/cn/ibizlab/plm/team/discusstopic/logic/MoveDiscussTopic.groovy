...
/**
 * 实体[DISCUSS_TOPIC]处理逻辑[移动话题]运行时对象
 * 此代码用户功能扩展代码
 *
 * 高级设置中移动项目
 */
class MoveDiscussTopic extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MoveDiscussTopic.class)
    ...
    /**
     * 执行逻辑节点[绑定话题信息参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[循环处理话题]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备更新话题参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
