...
/**
 * 实体[DISCUSS_TOPIC]处理逻辑[生成最近访问]运行时对象
 * 此代码用户功能扩展代码
 *
 * 在用户对数据进行了get或update操作时生成相应的访问记录。type为3，不在界面上进行显示
 */
class CreateRecent extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CreateRecent.class)
    ...
    /**
     * 执行逻辑节点[准备最近访问参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
