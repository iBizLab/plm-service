...
/**
 * 实体[DISCUSS_POST]处理逻辑[讨论中评论数计数器]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class DiscussPostCount extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DiscussPostCount.class)
