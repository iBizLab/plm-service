package cn.ibizlab.plm.team.discusspost.logic
...
/**
 * 实体[DISCUSS_POST]处理逻辑[获取话题成员（移动端）]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MobGetTopicMember extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MobGetTopicMember.class)
