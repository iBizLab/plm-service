...
/**
 * 实体[DISCUSS_TOPIC]处理逻辑[激活]运行时对象
 * 此代码用户功能扩展代码
 *
 * 激活已归档状态话题，修改话题的归档属性
 */
class Activate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(Activate.class)
    ...
    /**
     * 执行逻辑节点[设置归档状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
