...
/**
 * 实体[SHARED_SPACE]处理逻辑[获取共享空间信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取共享空间信息
 */
class SharedPageInfo extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SharedPageInfo.class)
