package cn.ibizlab.plm.wiki.baselinepage.logic
...
/**
 * 实体[BASELINE_PAGE]处理逻辑[基线对比数据查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 基线对比数据获取，查询两个基线下的页面
 */
class BaselineComparison extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[获取当前基线下页面]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充页面过滤器参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取对比基线下的页面]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取最新版本页面]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[填充最新版本页面附加属性]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
