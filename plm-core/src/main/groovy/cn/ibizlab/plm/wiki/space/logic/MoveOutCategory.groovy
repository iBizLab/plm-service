...
/**
 * 实体[SPACE]处理逻辑[移出分类]运行时对象
 * 此代码用户功能扩展代码
 *
 * 将空间移除分类
 */
class MoveOutCategory extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MoveOutCategory.class)
    ...
    /**
     * 执行逻辑节点[置空分类属性值]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
