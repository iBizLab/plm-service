...
/**
 * 实体[SPACE]处理逻辑[判断当前用户角色]运行时对象
 * 此代码用户功能扩展代码
 *
 * 判断当前用户角色
 */
class RecognizeCurUserRole extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RecognizeCurUserRole.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            ...
            case "RAWSFCODE6":
                //执行逻辑节点[普通用户]
                executeRAWSFCODE6(iDELogicSession, iPSDELogicNode)
                break
            case "PREPAREPARAM7":
                //执行逻辑节点[绑定用户数据到for_obj]
            ...
            case "RAWSFCODE5":
                //执行逻辑节点[管理员]
                executeRAWSFCODE5(iDELogicSession, iPSDELogicNode)
                break
            case "RAWSFCODE7":
                //执行逻辑节点[普通用户]
                executeRAWSFCODE7(iDELogicSession, iPSDELogicNode)
                break
            case "END6":
                //执行逻辑节点[结束]
    ...
    /**
     * 执行逻辑节点[获取项目ID并设置过滤参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取产品ID并设置过滤参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询当前用户是否为产品成员]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询当前用户是否为项目成员]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[返回系统管理员权限]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[只读参数设置为空]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[普通用户]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    private void executeRAWSFCODE6(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executeRAWSFCODE5(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
     ...
     * @throws Throwable
     */
    private void executeRAWSFCODE7(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
