...
/**
 * 实体[PAGE]处理逻辑[校验共享访问密码]运行时对象
 * 此代码用户功能扩展代码
 *
 * 校验共享访问密码
 */
class AccessPassword extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AccessPassword.class)
    ...
    /**
     * 执行逻辑节点[填充校验标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[校验链接是否有效]，逻辑类型[RAWSFCODE]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
