...
/**
 * 实体[PAGE]处理逻辑[同步发布名称与名称]运行时对象
 * 此代码用户功能扩展代码
 *
 * 同步发布名称与名称
 */
class SyncName extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SyncName.class)
    ...
    /**
     * 执行逻辑节点[设置共享人名称]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
