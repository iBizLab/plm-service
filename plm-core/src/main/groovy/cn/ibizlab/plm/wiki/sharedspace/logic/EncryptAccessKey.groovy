...
/**
 * 实体[SHARED_SPACE]处理逻辑[访问密码加密]运行时对象
 * 此代码用户功能扩展代码
 *
 * 访问密码加密
 */
class EncryptAccessKey extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(EncryptAccessKey.class)
