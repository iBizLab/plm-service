...
/**
 * 实体[PAGE]处理逻辑[保存命名版本]运行时对象
 * 此代码用户功能扩展代码
 *
 * 设置命名版本：新建命名版本并保存
 */
class SetNameVersion extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SetNameVersion.class)
    ...
    /**
     * 执行逻辑节点[获取操作表单数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
