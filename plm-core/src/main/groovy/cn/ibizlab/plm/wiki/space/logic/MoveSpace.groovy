...
/**
 * 实体[SPACE]处理逻辑[移动空间]运行时对象
 * 此代码用户功能扩展代码
 *
 * 更新空间的所属、可见范围
 */
class MoveSpace extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MoveSpace.class)
    ...
    /**
     * 执行逻辑节点[绑定要更改的数据]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备待更新的空间数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
