...
/**
 * 实体[SHARED_SPACE]处理逻辑[关闭共享]运行时对象
 * 此代码用户功能扩展代码
 *
 * 关闭共享
 */
class ClosedShared extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ClosedShared.class)
    ...
    /**
     * 执行逻辑节点[设置页面关闭参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
