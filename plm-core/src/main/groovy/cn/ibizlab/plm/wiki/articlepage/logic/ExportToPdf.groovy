...
/**
 * 实体[PAGE]处理逻辑[导出页面为pdf]运行时对象
 * 此代码用户功能扩展代码
 *
 * 导出页面为pdf
 */
class ExportToPdf extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ExportToPdf.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            ...
            case "SFPLUGIN1":
                //执行逻辑节点[服务插件]
                executeSFPLUGIN1(iDELogicSession, iPSDELogicNode)
                break
            default:
    ...
    /**
     * 执行逻辑节点[服务插件]，逻辑类型[SFPLUGIN]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    private void executeSFPLUGIN1(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        super.onExecutePSDELogicNode(iDELogicSession, iPSDELogicNode, true)
    }
}
