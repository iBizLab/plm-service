...
/**
 * 实体[SPACE]处理逻辑[标记主空间]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class MarkMainSpace extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MarkMainSpace.class)
