...
/**
 * 实体[PAGE]处理逻辑[移动子页面]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移动子页面至知识空间
 */
class MoveChildPage extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MoveChildPage.class)
    ...
    /**
     * 执行逻辑节点[设置父页面id和空间id]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取父页面的所有子页面]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置空间id]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置递归参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
