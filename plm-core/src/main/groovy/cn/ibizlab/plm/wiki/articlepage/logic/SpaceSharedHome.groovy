...
/**
 * 实体[PAGE]处理逻辑[共享空间主页]运行时对象
 * 此代码用户功能扩展代码
 *
 * 共享空间下获取主页
 */
class SpaceSharedHome extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SpaceSharedHome.class)
