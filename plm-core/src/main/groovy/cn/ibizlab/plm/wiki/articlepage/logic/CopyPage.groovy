...
/**
 * 实体[PAGE]处理逻辑[复制页面]运行时对象
 * 此代码用户功能扩展代码
 *
 * 复制页面，会调用复制子页面处理逻辑
 */
class CopyPage extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CopyPage.class)
    ...
    /**
     * 执行逻辑节点[设置待复制页面ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置待复制页面数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置待保存的页面]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备子页面复制参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
