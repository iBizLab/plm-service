...
/**
 * 实体[PAGE]处理逻辑[解锁页面]运行时对象
 * 此代码用户功能扩展代码
 *
 * 修改页面的is_lock字段
 */
class UnlockPage extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UnlockPage.class)
    ...
    /**
     * 执行逻辑节点[设置is_lock字段]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
