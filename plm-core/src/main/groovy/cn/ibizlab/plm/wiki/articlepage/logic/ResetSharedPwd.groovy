...
/**
 * 实体[PAGE]处理逻辑[置空共享访问密码]运行时对象
 * 此代码用户功能扩展代码
 *
 * 默认Get行为Reset共享访问密码
 */
class ResetSharedPwd extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ResetSharedPwd.class)
    ...
    /**
     * 执行逻辑节点[置空访问密码]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
