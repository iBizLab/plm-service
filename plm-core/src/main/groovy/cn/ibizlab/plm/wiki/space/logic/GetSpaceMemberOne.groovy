...
/**
 * 实体[SPACE]处理逻辑[获取知识空间成员]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取知识空间成员信息，用于判断当前用户权限
 */
class GetSpaceMemberOne extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetSpaceMemberOne.class)
    ...
    /**
     * 执行逻辑节点[获取知识空间ID并设置过滤参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[查询当前用户是否为知识空间成员]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
