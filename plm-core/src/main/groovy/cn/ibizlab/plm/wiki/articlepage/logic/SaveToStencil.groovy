...
/**
 * 实体[PAGE]处理逻辑[另存为模板]运行时对象
 * 此代码用户功能扩展代码
 *
 * 将当前页面存为组织/空间模板
 */
class SaveToStencil extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SaveToStencil.class)
    ...
    /**
     * 执行逻辑节点[设置为空间可见模板]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取页面数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[输出当前循环数据]，逻辑类型[DEBUGPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置为组织可见模板]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
