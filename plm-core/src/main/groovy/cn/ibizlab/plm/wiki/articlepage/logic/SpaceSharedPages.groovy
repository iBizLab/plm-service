...
/**
 * 实体[PAGE]处理逻辑[查询空间下的共享页面]运行时对象
 * 此代码用户功能扩展代码
 *
 * 查询空间下的共享页面，通过父级标识查询子页面
 */
class SpaceSharedPages extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SpaceSharedPages.class)
