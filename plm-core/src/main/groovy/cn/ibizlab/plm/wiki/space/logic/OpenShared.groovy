...
/**
 * 实体[SPACE]处理逻辑[开启共享]运行时对象
 * 此代码用户功能扩展代码
 *
 * 空间开启共享
 */
class OpenShared extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(OpenShared.class)
    ...
    /**
     * 执行逻辑节点[设置默认共享状态]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
