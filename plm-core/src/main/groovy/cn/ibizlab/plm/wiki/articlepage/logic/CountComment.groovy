...
/**
 * 实体[PAGE]处理逻辑[统计页面评论数]运行时对象
 * 此代码用户功能扩展代码
 *
 * 统计页面评论数
 */
class CountComment extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CountComment.class)
    ...
    /**
     * 执行逻辑节点[统计页面评论数]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
