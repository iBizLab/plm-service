...
/**
 * 实体[PAGE]处理逻辑[共享空间下搜索页面]运行时对象
 * 此代码用户功能扩展代码
 *
 * 共享空间下搜索页面时使用
 */
class SpaceSharedSearch extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SpaceSharedSearch.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            ...
            case "DEACTION1":
                ...
                break
            case "PREPAREPARAM2":
                //执行逻辑节点[页面标识需存在共享空间的shared_pages属性中]
    ...
    /**
     * 执行逻辑节点[填充共享空间标识]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[页面标识需存在共享空间的shared_pages属性中]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
