...
/**
 * 实体[PAGE]处理逻辑[基线规划页面数据查询]运行时对象
 * 此代码用户功能扩展代码
 *
 * 基线规划工作项时，填充页面当前版本名称
 */
class BaselinePlanPage extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(BaselinePlanPage.class)
    ...
    /**
     * 执行逻辑节点[设置当前版本]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
