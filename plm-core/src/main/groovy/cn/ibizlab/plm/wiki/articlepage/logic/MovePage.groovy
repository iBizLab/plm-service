...
/**
 * 实体[PAGE]处理逻辑[移动页面]运行时对象
 * 此代码用户功能扩展代码
 *
 * 移动页面至知识空间
 */
class MovePage extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(MovePage.class)
    ...
    /**
     * 执行逻辑节点[设置待移动页面ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置待移动页面数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置待更新的页面]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备移动子页面的数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
