...
/**
 * 实体[PAGE]处理逻辑[获取草稿页面]运行时对象
 * 此代码用户功能扩展代码
 *
 * 查询并返回草稿数据
 */
class GetDraftPages extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(GetDraftPages.class)
