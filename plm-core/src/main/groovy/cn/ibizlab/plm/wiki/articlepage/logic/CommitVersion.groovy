...
/**
 * 实体[PAGE]处理逻辑[生成版本]运行时对象
 * 此代码用户功能扩展代码
 *
 * 生成页面版本
 */
class CommitVersion extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CommitVersion.class)
    ...
    protected void onExecutePSDELogicNode(IDELogicSession iDELogicSession, IPSDELogicNode iPSDELogicNode) throws Throwable {
        switch (iPSDELogicNode.getCodeName()) {
            ...
            case "COMMIT_VERSION":
                //执行逻辑节点[建立版本]
                executeCommitVersion(iDELogicSession, iPSDELogicNode)
                break
            default:
    ...
    /**
     * 执行逻辑节点[准备版本信息]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重置版本信息]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
