...
class PageVersion extends GroovyDataEntityRuntime<PageVersion,PageVersionDTO,PageVersionFilterDTO> {
    ...
    def create(PageVersionDTO dto) throws Throwable {
    ...
    def update(PageVersionDTO dto) throws Throwable {
    ...
    def getDraft(PageVersionDTO dto) throws Throwable {
    ...
    def checkKey(PageVersionDTO dto) throws Throwable {
    ...
    def save(PageVersionDTO dto) throws Throwable {
    ...
    def fetchDefault(PageVersionFilterDTO context) throws Throwable {
