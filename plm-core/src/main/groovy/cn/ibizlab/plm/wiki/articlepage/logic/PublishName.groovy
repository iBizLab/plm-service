...
/**
 * 实体[PAGE]处理逻辑[发布名称]运行时对象
 * 此代码用户功能扩展代码
 *
 * 页面树更新发布名称，同步更新名称
 */
class PublishName extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(PublishName.class)
    ...
    /**
     * 执行逻辑节点[发布名称赋值]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
