...
/**
 * 实体[PAGE]处理逻辑[获取页面共享链接]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取页面共享链接
 */
class SharedUrl extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(SharedUrl.class)
