package cn.ibizlab.plm.wiki.stencil.logic
...
/**
 * 实体[STENCIL]处理逻辑[根据模板建立页面草稿]运行时对象
 * 此代码用户功能扩展代码
 *
 * 获取页面的模板数据，并返回
 */
class NewDraftFormStencil extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(NewDraftFormStencil.class)
    ...
    /**
     * 执行逻辑节点[获取模板ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[根据模板ID获取模板信息]，逻辑类型[DEACTION]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[设置返回数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
