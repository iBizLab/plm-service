...
class UserRole extends GroovyDataEntityRuntime<UserRole,UserRoleDTO,UserRoleFilterDTO> {
    ...
    def create(UserRoleDTO dto) throws Throwable {
    ...
    def update(UserRoleDTO dto) throws Throwable {
    ...
    def getDraft(UserRoleDTO dto) throws Throwable {
    ...
    def checkKey(UserRoleDTO dto) throws Throwable {
    ...
    def save(UserRoleDTO dto) throws Throwable {
    ...
    def fetchDefault(UserRoleFilterDTO context) throws Throwable {
