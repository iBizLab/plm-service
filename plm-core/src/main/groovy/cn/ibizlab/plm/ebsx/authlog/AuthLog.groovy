...
class AuthLog extends GroovyDataEntityRuntime<AuthLog,AuthLogDTO,AuthLogFilterDTO> {
    ...
    def create(AuthLogDTO dto) throws Throwable {
    ...
    def update(AuthLogDTO dto) throws Throwable {
    ...
    def getDraft(AuthLogDTO dto) throws Throwable {
    ...
    def checkKey(AuthLogDTO dto) throws Throwable {
    ...
    def save(AuthLogDTO dto) throws Throwable {
    ...
    def fetchCurUser(AuthLogFilterDTO context) throws Throwable {
    ...
    def fetchDefault(AuthLogFilterDTO context) throws Throwable {
