package cn.ibizlab.plm.ebsx.appviewtheme.logic
...
/**
 * 实体[APP_VIEW_THEME]处理逻辑[获取过滤条件]运行时对象
 * 此代码用户功能扩展代码
 *
 * null
 */
class FillSearchConds extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(FillSearchConds.class)
