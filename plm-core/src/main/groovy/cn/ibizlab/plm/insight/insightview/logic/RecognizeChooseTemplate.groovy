...
/**
 * 实体[INSIGHT_VIEW]处理逻辑[判断是否需要选择模板]运行时对象
 * 此代码用户功能扩展代码
 *
 * 判断是否需要选择模板
 */
class RecognizeChooseTemplate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(RecognizeChooseTemplate.class)
    ...
    /**
     * 执行逻辑节点[返回无仪表盘]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
