...
/**
 * 实体[INSIGHT_VIEW]处理逻辑[移动视图]运行时对象
 * 此代码用户功能扩展代码
 *
 * 视图更多设置移动视图

 */
class ViewMove extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(ViewMove.class)
    ...
    /**
     * 执行逻辑节点[准备更新视图参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
