package cn.ibizlab.plm.insight.insightview.logic
...
/**
 * 实体[INSIGHT_VIEW]处理逻辑[变更管理员角色]运行时对象
 * 此代码用户功能扩展代码
 *
 * 批量变更管理员角色身份（role_id）
 */
class ChangeAdminRole extends DELogicRuntime {
    ...
    /**
     * 执行逻辑节点[绑定视图成员参数]，逻辑类型[BINDPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[循环处理成员信息]，逻辑类型[LOOPSUBCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[重新建立更新成员参数]，逻辑类型[RENEWPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
