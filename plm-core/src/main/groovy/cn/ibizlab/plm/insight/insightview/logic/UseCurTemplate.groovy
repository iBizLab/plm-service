...
/**
 * 实体[INSIGHT_VIEW]处理逻辑[使用此模板]运行时对象
 * 此代码用户功能扩展代码
 *
 * 使用此模板
 */
class UseCurTemplate extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(UseCurTemplate.class)
    ...
    /**
     * 执行逻辑节点[查询当前视图下的看板]，逻辑类型[DEDATASET]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[获取选中看板ID]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备新看板参数]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
