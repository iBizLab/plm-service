...
/**
 * 实体[INSIGHT_VIEW]处理逻辑[自动创建人员]运行时对象
 * 此代码用户功能扩展代码
 *
 * 自动创建人员
 */
class AutoCreateMembers extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(AutoCreateMembers.class)
    ...
    /**
     * 执行逻辑节点[准备用户数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
    ...
    /**
     * 执行逻辑节点[准备查询数据]，逻辑类型[PREPAREPARAM]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
