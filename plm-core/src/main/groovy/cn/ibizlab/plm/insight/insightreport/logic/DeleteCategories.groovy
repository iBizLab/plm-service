...
/**
 * 实体[INSIGHT_REPORT]处理逻辑[删除类别]运行时对象
 * 此代码用户功能扩展代码
 *
 * 当类别删除时修改发布的类别属性
 */
class DeleteCategories extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(DeleteCategories.class)
    ...
    /**
     * 执行逻辑节点[直接SQL调用当类别删除时修改发布的类别属性]，逻辑类型[RAWSQLCALL]
     * @param iDELogicSession
     * @param iPSDELogicNode
     * @throws Throwable
     */
