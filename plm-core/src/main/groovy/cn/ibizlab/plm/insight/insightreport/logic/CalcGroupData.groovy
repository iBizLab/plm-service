...
/**
 * 实体[INSIGHT_REPORT]处理逻辑[计算分组信息]运行时对象
 * 此代码用户功能扩展代码
 *
 * 计算分组信息
 */
class CalcGroupData extends DELogicRuntime {

    private static final Log log = LogFactory.getLog(CalcGroupData.class)
